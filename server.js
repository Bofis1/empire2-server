...
const ZONE_SPAWNS = {
  ...
  void: [
    ...
    {tx:80,tz:114,type:'void_stalker'},{tx:117,tz:128,type:'void_construct'},{tx:116,tz:125,type:'void_stalker'},
    {tx:113,tz:123,type:'void_eye'},{tx:119,tz:126,type:'void_stalker'},{tx:157,tz:116,type:'void_stalker'},
    {tx:162,tz:117,type:'void_stalker'},{tx:185,tz:112,type:'void_sentinel'},{tx:188,tz:119,type:'void_construct'},
    {tx:192,tz:113,type:'wraith'},{tx:17,tz:146,type:'void_stalker'},{tx:15,tz:144,type:'void_stalker'},
    {tx:56,tz:154,type:'void_stalker'},{tx:52,tz:152,type:'void_stalker'},{tx:58,tz:157,type:'void_eye'},
    {tx:55,tz:156,type:'void_stalker'},{tx:86,tz:146,type:'void_stalker'},{tx:91,tz:143,type:'void_sentinel'},
    {tx:90,tz:150,type:'void_eye'},{tx:86,tz:150,type:'void_sentinel'},{tx:117,tz:150,type:'void_sentinel'},
    {tx:122,tz:153,type:'void_construct'},{tx:120,tz:154,type:'wraith'},{tx:119,tz:150,type:'void_construct'},
    {tx:149,tz:162,type:'void_stalker'},{tx:149,tz:164,type:'void_stalker'},{tx:147,tz:163,type:'void_eye'},
    {tx:185,tz:149,type:'void_construct'},{tx:178,tz:149,type:'void_stalker'},{tx:187,tz:148,type:'void_eye'},
    {tx:183,tz:146,type:'void_stalker'},{tx:220,tz:158,type:'void_sentinel'},{tx:221,tz:152,type:'void_construct'},
    {tx:214,tz:157,type:'wraith'},{tx:20,tz:185,type:'void_spike_horror'},{tx:16,tz:181,type:'void_phantom'},
    {tx:49,tz:194,type:'void_spike_horror'},{tx:49,tz:190,type:'void_phantom'},{tx:47,tz:190,type:'void_stalker'},
    {tx:85,tz:186,type:'void_eye'},{tx:87,tz:180,type:'void_eye'},{tx:94,tz:187,type:'void_phantom'},
    {tx:118,tz:189,type:'void_stalker'},{tx:112,tz:191,type:'void_sentinel'},{tx:112,tz:194,type:'void_eye'},
    {tx:116,tz:190,type:'void_sentinel'},{tx:150,tz:192,type:'void_eye'},{tx:156,tz:195,type:'void_eye'},
    {tx:178,tz:184,type:'void_stalker'},{tx:183,tz:187,type:'void_sentinel'},{tx:185,tz:189,type:'void_eye'},
    {tx:181,tz:185,type:'void_sentinel'},{tx:215,tz:182,type:'void_construct'},{tx:219,tz:185,type:'void_stalker'},
    {tx:216,tz:185,type:'void_eye'},{tx:212,tz:184,type:'void_stalker'},{tx:28,tz:223,type:'void_construct'},
    {tx:27,tz:223,type:'void_stalker'},{tx:20,tz:221,type:'void_eye'},{tx:28,tz:225,type:'void_stalker'},
    {tx:48,tz:225,type:'void_construct'},{tx:45,tz:219,type:'void_stalker'},{tx:50,tz:222,type:'void_eye'},
    {tx:89,tz:219,type:'void_eye'},{tx:91,tz:221,type:'void_phantom'},{tx:149,tz:214,type:'void_eye'},
    {tx:151,tz:217,type:'void_eye'},{tx:187,tz:222,type:'void_phantom'},{tx:185,tz:222,type:'void_stalker'}
  ],
  citadel: [
