...
const ZONE_SCALE = {
  ...
  sanctuary:1.0, dragonlair:1.0, riftvale:1.0, void_citadel:1.0, xumen:1.0,
...
const ZONE_SPAWNS = {
  ...
  caves_of_despair: [
    {tx:8,tz:8,type:'xu_miner'},
    {tx:14,tz:6,type:'xu_miner'},
    {tx:18,tz:10,type:'xu_miner'},
    {tx:10,tz:14,type:'xu_overseer'},
    {tx:22,tz:8,type:'xu_miner'},
    {tx:6,tz:16,type:'xu_miner'},
    {tx:16,tz:18,type:'xu_miner'},
    {tx:18,tz:20,type:'xu_miner'},
    {tx:14,tz:20,type:'xu_miner'},
    {tx:20,tz:18,type:'xu_overseer'},
    {tx:22,tz:22,type:'xu_miner'},
    {tx:12,tz:22,type:'xu_miner'},
    {tx:24,tz:16,type:'xu_miner'},
    {tx:10,tz:18,type:'xu_overseer'},
    {tx:28,tz:10,type:'xu_miner'},
    {tx:32,tz:8,type:'xu_miner'},
    {tx:30,tz:14,type:'xu_overseer'},
    {tx:34,tz:12,type:'xu_miner'},
    {tx:28,tz:18,type:'xu_miner'},
    {tx:30,tz:20,type:'xu_miner'},
    {tx:32,tz:18,type:'xu_overseer'},
    {tx:14,tz:28,type:'xu_miner'},
    {tx:18,tz:30,type:'xu_overseer'},
    {tx:22,tz:28,type:'xu_miner'},
    {tx:26,tz:32,type:'xu_miner'},
    {tx:12,tz:32,type:'xu_overseer'},
    {tx:20,tz:34,type:'xu_miner'},
    {tx:30,tz:28,type:'xu_miner'},
    {tx:32,tz:30,type:'xu_miner'},
    {tx:34,tz:28,type:'xu_overseer'},
    {tx:36,tz:36,type:'xu_overseer'},
    {tx:38,tz:34,type:'xu_overseer'},
    {tx:34,tz:38,type:'xu_miner'},
    {tx:40,tz:38,type:'xu_miner'},
    {tx:36,tz:40,type:'xu_miner'},
    {tx:38,tz:40,type:'xu_overseer'},
    {tx:40,tz:36,type:'xu_miner'}
  ],
  ashlands: [
  ...
  void_citadel: [
    {tx:10,tz:10,type:'void_construct'},{tx:14,tz:8, type:'void_sentinel'},
    {tx:18,tz:10,type:'void_construct'},{tx:22,tz:8, type:'rift_stalker'},
    {tx:8, tz:16,type:'rift_stalker'},  {tx:12,tz:15,type:'void_construct'},
    {tx:20,tz:18,type:'void_construct'},{tx:22,tz:18,type:'void_sentinel'},
    {tx:18,tz:20,type:'rift_stalker'},  {tx:24,tz:20,type:'void_construct'},
    {tx:28,tz:14,type:'void_sentinel'}, {tx:30,tz:16,type:'rift_weaver'},
    {tx:32,tz:12,type:'void_construct'},{tx:26,tz:22,type:'rift_stalker'},
    {tx:36,tz:20,type:'void_construct'},{tx:38,tz:18,type:'void_construct'},
    {tx:34,tz:24,type:'void_sentinel'}, {tx:40,tz:22,type:'rift_stalker'},
    {tx:44,tz:16,type:'rift_weaver'},   {tx:46,tz:20,type:'void_construct'},
    {tx:42,tz:26,type:'void_sentinel'}, {tx:48,tz:14,type:'rift_stalker'},
    {tx:50,tz:22,type:'void_construct'},{tx:52,tz:20,type:'void_sentinel'},
    {tx:48,tz:26,type:'rift_stalker'},  {tx:54,tz:24,type:'void_construct'},
    {tx:56,tz:18,type:'void_sentinel'}, {tx:58,tz:22,type:'rift_weaver'},
    {tx:52,tz:30,type:'void_construct'},{tx:60,tz:16,type:'rift_stalker'},
    {tx:20,tz:32,type:'void_construct'},{tx:22,tz:36,type:'rift_stalker'},
    {tx:18,tz:38,type:'rift_weaver'},   {tx:26,tz:34,type:'void_sentinel'},
    {tx:30,tz:38,type:'void_construct'},{tx:32,tz:40,type:'void_sentinel'},
    {tx:28,tz:42,type:'rift_stalker'},  {tx:34,tz:38,type:'void_construct'},
    {tx:40,tz:36,type:'void_sentinel'}, {tx:44,tz:34,type:'void_construct'},
    {tx:42,tz:40,type:'rift_weaver'},   {tx:46,tz:38,type:'void_sentinel'},
    {tx:50,tz:36,type:'void_construct'},{tx:52,tz:34,type:'void_sentinel'},
    {tx:48,tz:40,type:'rift_stalker'},  {tx:54,tz:38,type:'void_construct'},
    {tx:56,tz:42,type:'void_sentinel'}, {tx:60,tz:38,type:'rift_weaver'},
    {tx:58,tz:44,type:'void_construct'},{tx:62,tz:40,type:'rift_stalker'},
    {tx:42,tz:52,type:'void_construct'},{tx:46,tz:48,type:'void_sentinel'},
    {tx:50,tz:52,type:'rift_weaver'},   {tx:54,tz:50,type:'void_construct'},
    {tx:58,tz:52,type:'void_sentinel'}, {tx:62,tz:48,type:'rift_stalker'},
    {tx:65,tz:54,type:'void_construct'},{tx:68,tz:50,type:'void_sentinel'},
    {tx:62,tz:56,type:'rift_weaver'},   {tx:70,tz:54,type:'void_construct'},
  ],
};
;
