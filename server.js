...
const ZONE_SPAWNS = {
  ...
  patrol: [
    {tx:20,tz:27,type:'xu_rebel'},
    {tx:19,tz:32,type:'xu_rebel'},
    {tx:25,tz:29,type:'xu_rebel'},
    {tx:23,tz:33,type:'bandit'},
    {tx:25,tz:31,type:'bandit'},
    {tx:25,tz:32,type:'bandit'},
    {tx:25,tz:22,type:'bandit_archer'},
    {tx:33,tz:11,type:'bandit_archer'},
    {tx:25,tz:10,type:'bandit_archer'},
    {tx:30,tz:22,type:'sniper'},
    {tx:24,tz:12,type:'sniper'},
    {tx:22,tz:29,type:'sniper'},
    {tx:20,tz:16,type:'xu_siege_bot'},
    {tx:31,tz:30,type:'xu_siege_bot'},
    {tx:24,tz:10,type:'xu_siege_bot'},
    {tx:187,tz:33,type:'xu_rebel'},
    {tx:185,tz:16,type:'xu_rebel'},
    {tx:192,tz:25,type:'xu_rebel'},
    {tx:190,tz:33,type:'bandit'},
    {tx:203,tz:11,type:'bandit'},
    {tx:209,tz:19,type:'bandit'},
    {tx:199,tz:33,type:'bandit_archer'},
    {tx:200,tz:18,type:'bandit_archer'},
    {tx:185,tz:14,type:'bandit_archer'},
    {tx:204,tz:24,type:'sniper'},
    {tx:208,tz:11,type:'sniper'},
    {tx:184,tz:29,type:'sniper'},
    {tx:202,tz:31,type:'xu_siege_bot'},
    {tx:184,tz:11,type:'xu_siege_bot'},
    {tx:203,tz:21,type:'xu_siege_bot'},
    {tx:17,tz:200,type:'xu_rebel'},
    {tx:21,tz:192,type:'xu_rebel'},
    {tx:18,tz:185,type:'xu_rebel'},
    {tx:33,tz:197,type:'bandit'},
    {tx:21,tz:195,type:'bandit'},
    {tx:11,tz:185,type:'bandit'},
    {tx:10,tz:189,type:'bandit_archer'},
    {tx:11,tz:201,type:'bandit_archer'},
    {tx:19,tz:190,type:'bandit_archer'},
    {tx:29,tz:193,type:'sniper'},
    {tx:27,tz:188,type:'sniper'},
    {tx:23,tz:202,type:'sniper'},
    {tx:33,tz:200,type:'xu_siege_bot'},
    {tx:17,tz:192,type:'xu_siege_bot'},
    {tx:13,tz:203,type:'xu_siege_bot'},
    {tx:203,tz:192,type:'xu_rebel'},
    {tx:215,tz:190,type:'xu_rebel'},
    {tx:213,tz:205,type:'xu_rebel'},
    {tx:193,tz:205,type:'bandit'},
    {tx:206,tz:192,type:'bandit'},
    {tx:191,tz:199,type:'bandit'},
    {tx:193,tz:202,type:'bandit_archer'},
    {tx:201,tz:199,type:'bandit_archer'},
    {tx:202,tz:213,type:'bandit_archer'},
    {tx:208,tz:196,type:'sniper'},
    {tx:205,tz:193,type:'sniper'},
    {tx:206,tz:204,type:'sniper'},
    {tx:191,tz:189,type:'xu_siege_bot'},
    {tx:202,tz:203,type:'xu_siege_bot'},
    {tx:216,tz:193,type:'xu_siege_bot'},
    {tx:42,tz:35,type:'xu_scout'},
    {tx:207,tz:205,type:'xu_siege_bot'},
    {tx:20,tz:155,type:'xu_commander'},
    {tx:152,tz:195,type:'wraith'},
    {tx:42,tz:205,type:'xu_scout'},
    {tx:155,tz:108,type:'xu_siege_bot'},
    {tx:196,tz:165,type:'xu_commander'},
    {tx:155,tz:174,type:'wraith'},
    {tx:35,tz:64,type:'xu_scout'},
    {tx:35,tz:42,type:'xu_siege_bot'},
    {tx:174,tz:125,type:'xu_commander'},
    {tx:165,tz:53,type:'wraith'},
    {tx:75,tz:141,type:'xu_scout'},
    {tx:205,tz:97,type:'xu_siege_bot'},
    {tx:97,tz:45,type:'xu_commander'},
    {tx:205,tz:108,type:'wraith'},
    {tx:218,tz:35,type:'xu_scout'},
    {tx:35,tz:196,type:'xu_siege_bot'},
    {tx:115,tz:75,type:'xu_commander'},
    {tx:31,tz:125,type:'wraith'},
    {tx:35,tz:97,type:'xu_scout'},
    {tx:75,tz:207,type:'xu_siege_bot'},
    {tx:75,tz:31,type:'xu_commander'},
    {tx:75,tz:86,type:'wraith'},
    {tx:45,tz:174,type:'xu_scout'},
    {tx:130,tz:45,type:'xu_siege_bot'},
    {tx:155,tz:64,type:'xu_commander'},
    {tx:195,tz:185,type:'wraith'},
    {tx:86,tz:165,type:'xu_scout'},
    {tx:53,tz:115,type:'xu_siege_bot'},
    {tx:53,tz:205,type:'xu_commander'},
    {tx:155,tz:42,type:'wraith'},
    {tx:42,tz:165,type:'xu_scout'},
    {tx:218,tz:115,type:'xu_siege_bot'},
    {tx:119,tz:85,type:'xu_commander'},
    {tx:155,tz:20,type:'wraith'},
    {tx:64,tz:35,type:'xu_scout'},
    {tx:205,tz:152,type:'xu_siege_bot'},
    {tx:152,tz:165,type:'xu_commander'},
    {tx:165,tz:152,type:'wraith'},
    {tx:141,tz:75,type:'xu_scout'},
    {tx:35,tz:218,type:'xu_siege_bot'},
    {tx:195,tz:31,type:'xu_commander'},
    {tx:165,tz:130,type:'wraith'},
    {tx:207,tz:45,type:'xu_scout'},
    {tx:108,tz:165,type:'xu_siege_bot'},
    {tx:205,tz:119,type:'xu_commander'},
    {tx:85,tz:64,type:'wraith'},
    {tx:20,tz:45,type:'xu_scout'},
    {tx:185,tz:75,type:'xu_siege_bot'},
    {tx:42,tz:75,type:'xu_commander'},
    {tx:155,tz:196,type:'xu_scout'},
    {tx:75,tz:125,type:'xu_siege_bot'},
    {tx:163,tz:155,type:'xu_commander'},
    {tx:45,tz:86,type:'xu_scout'},
    {tx:205,tz:174,type:'xu_scout'},
    {tx:86,tz:115,type:'xu_scout'},
    {tx:35,tz:141,type:'xu_scout'},
    {tx:196,tz:85,type:'xu_scout'},
    {tx:125,tz:207,type:'xu_scout'},
    {tx:125,tz:152,type:'xu_scout'},
    {tx:205,tz:53,type:'xu_scout'},
    {tx:196,tz:45,type:'xu_scout'},
    {tx:75,tz:97,type:'xu_scout'},
    {tx:75,tz:174,type:'xu_scout'},
    {tx:85,tz:218,type:'xu_scout'},
    {tx:35,tz:185,type:'xu_scout'},
    {tx:45,tz:20,type:'xu_scout'},
    {tx:155,tz:31,type:'xu_scout'},
    {tx:195,tz:64,type:'xu_scout'},
    {tx:205,tz:141,type:'xu_scout'},
    {tx:152,tz:45,type:'xu_scout'},
    {tx:130,tz:165,type:'xu_scout'},
    {tx:20,tz:205,type:'xu_scout'},
    {tx:48,tz:116,type:'xu_rebel'},
    {tx:178,tz:110,type:'xu_rebel'},
    {tx:32,tz:51,type:'xu_rebel'},
    {tx:213,tz:152,type:'xu_rebel'},
    {tx:134,tz:69,type:'xu_rebel'},
    {tx:109,tz:30,type:'xu_rebel'},
    {tx:175,tz:129,type:'xu_rebel'},
    {tx:228,tz:143,type:'xu_rebel'},
    {tx:126,tz:37,type:'xu_rebel'},
    {tx:94,tz:223,type:'xu_rebel'},
    {tx:144,tz:173,type:'xu_rebel'},
    {tx:100,tz:226,type:'xu_rebel'},
    {tx:78,tz:191,type:'bandit'},
    {tx:26,tz:68,type:'bandit'},
    {tx:156,tz:20,type:'bandit'},
    {tx:154,tz:103,type:'bandit'},
  ],
  cemetery: [
    // camp 01 [elite guard]
  ...
  sunken_sands: [
    {tx:143,tz:141,type:'sand_worm'},
    {tx:100,tz:145,type:'sand_worm'},
    {tx:154,tz:121,type:'sand_worm'},
    {tx:119,tz:86,type:'sand_worm'},
    {tx:85,tz:125,type:'sand_worm'},
    {tx:88,tz:136,type:'sand_worm'},
    {tx:139,tz:88,type:'sand_worm'},
    {tx:156,tz:140,type:'sand_worm'},
    {tx:120,tz:159,type:'sand_worm'},
    {tx:157,tz:106,type:'sand_worm'},
    {tx:142,tz:157,type:'sand_worm'},
    {tx:109,tz:82,type:'sand_worm'},
    {tx:83,tz:96,type:'sand_worm'},
    {tx:103,tz:167,type:'sand_worm'},
    {tx:153,tz:80,type:'sand_worm'},
    {tx:84,tz:158,type:'sand_worm'},
    {tx:65,tz:117,type:'sand_worm'},
    {tx:171,tz:114,type:'sand_worm'},
    {tx:137,tz:172,type:'sand_mummy'},
    {tx:80,tz:82,type:'sand_mummy'},
    {tx:64,tz:100,type:'sand_mummy'},
    {tx:102,tz:177,type:'sand_mummy'},
    {tx:122,tz:182,type:'sand_mummy'},
    {tx:178,tz:101,type:'sand_mummy'},
    {tx:60,tz:137,type:'sand_mummy'},
    {tx:165,tz:166,type:'sand_mummy'},
    {tx:142,tz:60,type:'sand_mummy'},
    {tx:181,tz:138,type:'sand_mummy'},
    {tx:101,tz:61,type:'sand_mummy'},
    {tx:155,tz:174,type:'sand_mummy'},
    {tx:87,tz:175,type:'sand_mummy'},
    {tx:179,tz:151,type:'sand_mummy'},
    {tx:64,tz:77,type:'sand_mummy'},
    {tx:137,tz:48,type:'sand_mummy'},
    {tx:76,tz:63,type:'sand_mummy'},
    {tx:177,tz:79,type:'sand_mummy'},
    {tx:165,tz:62,type:'sand_mummy'},
    {tx:141,tz:196,type:'sand_mummy'},
    {tx:48,tz:97,type:'sand_mummy'},
    {tx:60,tz:163,type:'sand_mummy'},
    {tx:100,tz:46,type:'sand_mummy'},
    {tx:196,tz:116,type:'sand_mummy'},
    {tx:196,tz:141,type:'sand_mummy'},
    {tx:61,tz:178,type:'sand_mummy'},
    {tx:106,tz:201,type:'sand_mummy'},
    {tx:80,tz:49,type:'sand_mummy'},
    {tx:121,tz:37,type:'dune_skeleton'},
    {tx:114,tz:201,type:'dune_skeleton'},
    {tx:41,tz:143,type:'dune_skeleton'},
    {tx:198,tz:97,type:'dune_skeleton'},
    {tx:181,tz:177,type:'dune_skeleton'},
    {tx:37,tz:115,type:'dune_skeleton'},
    {tx:85,tz:196,type:'dune_skeleton'},
    {tx:64,tz:63,type:'dune_skeleton'},
    {tx:155,tz:198,type:'dune_skeleton'},
    {tx:44,tz:87,type:'dune_skeleton'},
    {tx:159,tz:46,type:'dune_skeleton'},
    {tx:196,tz:80,type:'dune_skeleton'},
    {tx:184,tz:59,type:'dune_skeleton'},
    {tx:199,tz:164,type:'dune_skeleton'},
    {tx:39,tz:156,type:'dune_skeleton'},
    {tx:67,tz:190,type:'dune_skeleton'},
    {tx:208,tz:134,type:'dune_skeleton'},
    {tx:29,tz:119,type:'dune_skeleton'},
    {tx:31,tz:99,type:'dune_skeleton'},
    {tx:105,tz:26,type:'dune_skeleton'},
    {tx:218,tz:115,type:'dune_skeleton'},
    {tx:24,tz:138,type:'dune_skeleton'},
    {tx:101,tz:212,type:'dune_skeleton'},
    {tx:116,tz:24,type:'dune_skeleton'},
    {tx:212,tz:154,type:'dune_skeleton'},
    {tx:179,tz:40,type:'dune_skeleton'},
    {tx:82,tz:29,type:'desert_snake'},
    {tx:180,tz:201,type:'desert_snake'},
    {tx:41,tz:57,type:'desert_snake'},
    {tx:200,tz:63,type:'desert_snake'},
    {tx:156,tz:215,type:'desert_snake'},
    {tx:29,tz:78,type:'desert_snake'},
    {tx:28,tz:164,type:'desert_snake'},
    {tx:217,tz:94,type:'desert_snake'},
    {tx:134,tz:18,type:'desert_snake'},
    {tx:201,tz:185,type:'desert_snake'},
    {tx:84,tz:215,type:'desert_snake'},
    {tx:59,tz:41,type:'desert_snake'},
    {tx:139,tz:221,type:'desert_snake'},
    {tx:39,tz:187,type:'desert_snake'},
    {tx:165,tz:25,type:'desert_snake'},
    {tx:195,tz:43,type:'desert_snake'},
    {tx:48,tz:199,type:'desert_snake'},
    {tx:26,tz:67,type:'desert_snake'},
    {tx:42,tz:45,type:'desert_snake'},
    {tx:221,tz:76,type:'desert_snake'},
    {tx:181,tz:212,type:'desert_snake'},
    {tx:69,tz:221,type:'desert_snake'},
    {tx:201,tz:197,type:'desert_snake'},
    {tx:181,tz:24,type:'desert_snake'},
    {tx:60,tz:23,type:'desert_snake'},
    {tx:219,tz:184,type:'desert_snake'},
    {tx:19,tz:178,type:'desert_snake'},
    {tx:216,tz:50,type:'desert_snake'},
    {tx:224,tz:57,type:'desert_snake'},
    {tx:210,tz:199,type:'desert_snake'},
    {tx:194,tz:217,type:'desert_snake'},
    {tx:23,tz:197,type:'desert_snake'},
    {tx:43,tz:21,type:'desert_snake'},
    {tx:44,tz:218,type:'desert_snake'},
    {tx:23,tz:40,type:'sand_scorpion'},
    {tx:203,tz:22,type:'sand_scorpion'},
    {tx:21,tz:27,type:'sand_scorpion'},
    {tx:21,tz:212,type:'sand_scorpion'},
    {tx:210,tz:21,type:'sand_scorpion'},
    {tx:214,tz:219,type:'sand_scorpion'},
    {tx:146,tz:142,type:'sand_scorpion'},
    {tx:98,tz:143,type:'sand_scorpion'},
    {tx:155,tz:124,type:'sand_scorpion'},
    {tx:119,tz:85,type:'sand_scorpion'},
    {tx:88,tz:127,type:'sand_scorpion'},
    {tx:87,tz:139,type:'sand_scorpion'},
    {tx:140,tz:88,type:'sand_scorpion'},
    {tx:153,tz:140,type:'sand_scorpion'},
    {tx:121,tz:158,type:'sand_scorpion'},
    {tx:158,tz:105,type:'sand_scorpion'},
    {tx:139,tz:158,type:'sand_scorpion'},
    {tx:106,tz:81,type:'sand_scorpion'},
    {tx:86,tz:98,type:'sand_scorpion'},
    {tx:106,tz:164,type:'sand_scorpion'},
    {tx:153,tz:82,type:'sand_scorpion'},
    {tx:84,tz:160,type:'sand_scorpion'},
    {tx:70,tz:118,type:'sand_scorpion'},
    {tx:175,tz:115,type:'sand_scorpion'},
    {tx:134,tz:170,type:'sand_scorpion'},
    {tx:78,tz:82,type:'sand_scorpion'},
    {tx:64,tz:103,type:'sand_scorpion'},
    {tx:101,tz:173,type:'sand_scorpion'},
    {tx:123,tz:181,type:'sand_scorpion'},
    {tx:178,tz:103,type:'sand_scorpion'},
    {tx:61,tz:138,type:'sand_scorpion'},
    {tx:165,tz:165,type:'sand_scorpion'},
    {tx:142,tz:59,type:'sand_scorpion'},
    {tx:183,tz:139,type:'sand_scorpion'},
    {tx:102,tz:59,type:'sand_scorpion'},
    {tx:155,tz:177,type:'sand_scorpion'},
    {tx:88,tz:174,type:'sand_scorpion'},
    {tx:177,tz:153,type:'sand_scorpion'},
    {tx:63,tz:76,type:'sand_scorpion'},
    {tx:133,tz:49,type:'sand_scorpion'},
    {tx:78,tz:63,type:'sand_scorpion'},
    {tx:177,tz:77,type:'sand_scorpion'},
    {tx:166,tz:60,type:'sand_scorpion'},
    {tx:139,tz:195,type:'sand_scorpion'},
  ],
  frostveil: [
  ...
  ancient: [
    {tx:33,tz:67,type:'ancient_guardian'},
    {tx:31,tz:81,type:'ancient_guardian'},
    {tx:42,tz:64,type:'stone_sentinel'},
    {tx:45,tz:63,type:'stone_sentinel'},
    {tx:40,tz:77,type:'vine_horror'},
    {tx:36,tz:65,type:'vine_horror'},
    {tx:31,tz:71,type:'ancient_guardian'},
    {tx:32,tz:64,type:'ancient_guardian'},
    {tx:35,tz:79,type:'void_stalker'},
    {tx:41,tz:75,type:'void_stalker'},
    {tx:69,tz:36,type:'ancient_guardian'},
    {tx:81,tz:32,type:'ancient_guardian'},
    {tx:80,tz:47,type:'stone_sentinel'},
    {tx:69,tz:46,type:'stone_sentinel'},
    {tx:71,tz:38,type:'vine_horror'},
    {tx:79,tz:48,type:'vine_horror'},
    {tx:69,tz:42,type:'ancient_guardian'},
    {tx:81,tz:39,type:'ancient_guardian'},
    {tx:70,tz:40,type:'void_stalker'},
    {tx:74,tz:42,type:'void_stalker'},
    {tx:63,tz:74,type:'ancient_guardian'},
    {tx:81,tz:73,type:'ancient_guardian'},
    {tx:78,tz:63,type:'stone_sentinel'},
    {tx:67,tz:72,type:'stone_sentinel'},
    {tx:73,tz:66,type:'vine_horror'},
    {tx:77,tz:70,type:'vine_horror'},
    {tx:63,tz:71,type:'ancient_guardian'},
    {tx:77,tz:78,type:'ancient_guardian'},
    {tx:67,tz:71,type:'void_stalker'},
    {tx:79,tz:78,type:'void_stalker'},
    {tx:192,tz:64,type:'ancient_guardian'},
    {tx:203,tz:67,type:'ancient_guardian'},
    {tx:191,tz:66,type:'stone_sentinel'},
    {tx:209,tz:75,type:'stone_sentinel'},
    {tx:204,tz:80,type:'vine_horror'},
    {tx:191,tz:64,type:'vine_horror'},
    {tx:206,tz:74,type:'ancient_guardian'},
    {tx:197,tz:71,type:'ancient_guardian'},
    {tx:193,tz:69,type:'void_stalker'},
    {tx:193,tz:80,type:'void_stalker'},
    {tx:165,tz:48,type:'ancient_guardian'},
    {tx:165,tz:34,type:'ancient_guardian'},
    {tx:168,tz:42,type:'stone_sentinel'},
    {tx:167,tz:40,type:'stone_sentinel'},
    {tx:161,tz:48,type:'vine_horror'},
    {tx:173,tz:45,type:'vine_horror'},
    {tx:176,tz:38,type:'ancient_guardian'},
    {tx:169,tz:47,type:'ancient_guardian'},
    {tx:159,tz:35,type:'void_stalker'},
    {tx:177,tz:45,type:'void_stalker'},
    {tx:165,tz:63,type:'ancient_guardian'},
    {tx:162,tz:63,type:'ancient_guardian'},
    {tx:160,tz:78,type:'stone_sentinel'},
    {tx:177,tz:68,type:'stone_sentinel'},
    {tx:163,tz:76,type:'vine_horror'},
    {tx:159,tz:68,type:'vine_horror'},
    {tx:173,tz:75,type:'ancient_guardian'},
    {tx:167,tz:78,type:'ancient_guardian'},
    {tx:168,tz:72,type:'void_stalker'},
    {tx:177,tz:67,type:'void_stalker'},
    {tx:41,tz:162,type:'ancient_guardian'},
    {tx:39,tz:170,type:'ancient_guardian'},
    {tx:45,tz:164,type:'stone_sentinel'},
    {tx:35,tz:173,type:'stone_sentinel'},
    {tx:47,tz:175,type:'vine_horror'},
    {tx:36,tz:164,type:'vine_horror'},
    {tx:31,tz:173,type:'ancient_guardian'},
    {tx:33,tz:160,type:'ancient_guardian'},
    {tx:42,tz:160,type:'void_stalker'},
    {tx:47,tz:162,type:'void_stalker'},
    {tx:74,tz:205,type:'ancient_guardian'},
    {tx:80,tz:200,type:'ancient_guardian'},
    {tx:74,tz:206,type:'stone_sentinel'},
    {tx:70,tz:200,type:'stone_sentinel'},
    {tx:79,tz:193,type:'vine_horror'},
    {tx:69,tz:191,type:'vine_horror'},
    {tx:64,tz:208,type:'ancient_guardian'},
    {tx:71,tz:200,type:'ancient_guardian'},
    {tx:75,tz:192,type:'void_stalker'},
    {tx:66,tz:206,type:'void_stalker'},
    {tx:75,tz:171,type:'ancient_guardian'},
    {tx:70,tz:162,type:'ancient_guardian'},
    {tx:74,tz:163,type:'stone_sentinel'},
    {tx:76,tz:172,type:'stone_sentinel'},
    {tx:76,tz:176,type:'vine_horror'},
    {tx:68,tz:169,type:'vine_horror'},
    {tx:78,tz:166,type:'ancient_guardian'},
    {tx:78,tz:168,type:'ancient_guardian'},
    {tx:68,tz:166,type:'void_stalker'},
    {tx:81,tz:160,type:'void_stalker'},
    {tx:201,tz:175,type:'ancient_guardian'},
    {tx:197,tz:176,type:'ancient_guardian'},
    {tx:206,tz:167,type:'stone_sentinel'},
    {tx:205,tz:161,type:'stone_sentinel'},
    {tx:203,tz:160,type:'vine_horror'},
    {tx:205,tz:176,type:'vine_horror'},
    {tx:191,tz:160,type:'ancient_guardian'},
    {tx:196,tz:177,type:'ancient_guardian'},
    {tx:194,tz:175,type:'void_stalker'},
    {tx:201,tz:167,type:'void_stalker'},
    {tx:166,tz:201,type:'ancient_guardian'},
    {tx:176,tz:198,type:'ancient_guardian'},
    {tx:167,tz:201,type:'stone_sentinel'},
    {tx:168,tz:191,type:'stone_sentinel'},
    {tx:174,tz:196,type:'vine_horror'},
    {tx:165,tz:202,type:'vine_horror'},
    {tx:169,tz:193,type:'ancient_guardian'},
    {tx:168,tz:207,type:'ancient_guardian'},
    {tx:171,tz:209,type:'void_stalker'},
    {tx:173,tz:206,type:'void_stalker'},
    {tx:176,tz:159,type:'ancient_guardian'},
    {tx:163,tz:177,type:'ancient_guardian'},
    {tx:165,tz:164,type:'stone_sentinel'},
    {tx:163,tz:168,type:'stone_sentinel'},
    {tx:172,tz:163,type:'vine_horror'},
    {tx:164,tz:172,type:'vine_horror'},
    {tx:172,tz:161,type:'ancient_guardian'},
    {tx:164,tz:169,type:'ancient_guardian'},
    {tx:169,tz:160,type:'void_stalker'},
    {tx:171,tz:175,type:'void_stalker'},
    {tx:87,tz:97,type:'ancient_guardian'},
    {tx:94,tz:103,type:'ancient_guardian'},
    {tx:102,tz:91,type:'stone_sentinel'},
    {tx:87,tz:89,type:'stone_sentinel'},
    {tx:101,tz:101,type:'vine_horror'},
    {tx:97,tz:100,type:'vine_horror'},
    {tx:94,tz:90,type:'ancient_guardian'},
    {tx:104,tz:92,type:'ancient_guardian'},
    {tx:95,tz:88,type:'void_stalker'},
    {tx:91,tz:104,type:'void_stalker'},
    {tx:140,tz:101,type:'ancient_guardian'},
    {tx:135,tz:98,type:'ancient_guardian'},
    {tx:143,tz:92,type:'stone_sentinel'},
    {tx:137,tz:96,type:'stone_sentinel'},
    {tx:142,tz:104,type:'vine_horror'},
    {tx:137,tz:89,type:'vine_horror'},
    {tx:146,tz:91,type:'ancient_guardian'},
    {tx:144,tz:94,type:'ancient_guardian'},
    {tx:148,tz:105,type:'void_stalker'},
    {tx:148,tz:92,type:'void_stalker'},
    {tx:90,tz:137,type:'ancient_guardian'},
    {tx:98,tz:143,type:'ancient_guardian'},
    {tx:98,tz:145,type:'stone_sentinel'},
    {tx:94,tz:142,type:'stone_sentinel'},
    {tx:97,tz:140,type:'vine_horror'},
    {tx:100,tz:137,type:'vine_horror'},
    {tx:97,tz:145,type:'ancient_guardian'},
    {tx:88,tz:142,type:'ancient_guardian'},
    {tx:90,tz:153,type:'void_stalker'},
    {tx:92,tz:144,type:'void_stalker'},
    {tx:147,tz:150,type:'stone_sentinel'},
    {tx:151,tz:148,type:'stone_sentinel'},
    {tx:147,tz:138,type:'vine_horror'},
    {tx:142,tz:143,type:'vine_horror'},
    {tx:141,tz:152,type:'void_stalker'},
    {tx:143,tz:141,type:'void_stalker'},
    {tx:157,tz:115,type:'stone_sentinel'},
    {tx:103,tz:223,type:'void_stalker'},
    {tx:114,tz:178,type:'vine_horror'},
    {tx:28,tz:163,type:'stone_sentinel'},
    {tx:40,tz:205,type:'void_stalker'},
    {tx:144,tz:159,type:'vine_horror'},
    {tx:176,tz:80,type:'stone_sentinel'},
    {tx:55,tz:117,type:'void_stalker'},
    {tx:132,tz:155,type:'vine_horror'},
    {tx:132,tz:144,type:'void_stalker'},
    {tx:98,tz:20,type:'vine_horror'},
    {tx:155,tz:24,type:'stone_sentinel'},
    {tx:37,tz:156,type:'vine_horror'},
    {tx:161,tz:36,type:'stone_sentinel'},
    {tx:201,tz:53,type:'vine_horror'},
    {tx:113,tz:56,type:'stone_sentinel'},
    {tx:96,tz:101,type:'vine_horror'},
    {tx:35,tz:67,type:'stone_sentinel'},
    {tx:26,tz:72,type:'vine_horror'},
    {tx:84,tz:175,type:'stone_sentinel'},
    {tx:20,tz:35,type:'vine_horror'},
    {tx:80,tz:144,type:'stone_sentinel'},
    {tx:218,tz:115,type:'vine_horror'},
    {tx:87,tz:67,type:'stone_sentinel'},
    {tx:65,tz:42,type:'vine_horror'},
    {tx:178,tz:38,type:'stone_sentinel'},
    {tx:43,tz:171,type:'vine_horror'},
    {tx:208,tz:43,type:'stone_sentinel'},
    {tx:68,tz:80,type:'vine_horror'},
    {tx:36,tz:188,type:'stone_sentinel'},
    {tx:204,tz:81,type:'vine_horror'},
    {tx:24,tz:223,type:'stone_sentinel'},
    {tx:55,tz:218,type:'vine_horror'},
    {tx:215,tz:193,type:'stone_sentinel'},
    {tx:133,tz:80,type:'vine_horror'},
    {tx:101,tz:158,type:'stone_sentinel'},
    {tx:114,tz:37,type:'vine_horror'},
    {tx:207,tz:112,type:'stone_sentinel'},
    {tx:54,tz:65,type:'vine_horror'},
    {tx:22,tz:116,type:'stone_sentinel'},
    {tx:189,tz:222,type:'stone_sentinel'},
    {tx:73,tz:205,type:'stone_sentinel'},
    {tx:208,tz:130,type:'stone_sentinel'},
    {tx:67,tz:103,type:'stone_sentinel'},
  ],
  dragonlair: [
  ...
  riftvale: [
    {tx:41,tz:47,type:'rift_stalker'},
    {tx:44,tz:40,type:'rift_stalker'},
    {tx:49,tz:49,type:'rift_weaver'},
    {tx:32,tz:45,type:'rift_weaver'},
    {tx:35,tz:44,type:'psyche_horror'},
    {tx:43,tz:46,type:'psyche_horror'},
    {tx:44,tz:32,type:'rift_stalker'},
    {tx:42,tz:41,type:'rift_stalker'},
    {tx:42,tz:42,type:'void_colossus'},
    {tx:39,tz:42,type:'void_colossus'},
    {tx:75,tz:49,type:'rift_stalker'},
    {tx:78,tz:35,type:'rift_stalker'},
    {tx:68,tz:44,type:'rift_weaver'},
    {tx:73,tz:49,type:'rift_weaver'},
    {tx:72,tz:48,type:'psyche_horror'},
    {tx:67,tz:41,type:'psyche_horror'},
    {tx:76,tz:44,type:'rift_stalker'},
    {tx:71,tz:44,type:'rift_stalker'},
    {tx:76,tz:47,type:'void_colossus'},
    {tx:69,tz:41,type:'void_colossus'},
    {tx:42,tz:63,type:'rift_stalker'},
    {tx:48,tz:65,type:'rift_stalker'},
    {tx:49,tz:80,type:'rift_weaver'},
    {tx:41,tz:79,type:'rift_weaver'},
    {tx:39,tz:65,type:'psyche_horror'},
    {tx:47,tz:72,type:'psyche_horror'},
    {tx:36,tz:65,type:'rift_stalker'},
    {tx:47,tz:80,type:'rift_stalker'},
    {tx:31,tz:70,type:'void_colossus'},
    {tx:33,tz:66,type:'void_colossus'},
    {tx:209,tz:43,type:'rift_stalker'},
    {tx:195,tz:49,type:'rift_stalker'},
    {tx:197,tz:46,type:'rift_weaver'},
    {tx:197,tz:41,type:'rift_weaver'},
    {tx:204,tz:37,type:'psyche_horror'},
    {tx:192,tz:45,type:'psyche_horror'},
    {tx:193,tz:34,type:'rift_stalker'},
    {tx:194,tz:44,type:'rift_stalker'},
    {tx:195,tz:43,type:'void_colossus'},
    {tx:199,tz:45,type:'void_colossus'},
    {tx:167,tz:36,type:'rift_stalker'},
    {tx:164,tz:38,type:'rift_stalker'},
    {tx:177,tz:49,type:'rift_weaver'},
    {tx:164,tz:36,type:'rift_weaver'},
    {tx:173,tz:43,type:'psyche_horror'},
    {tx:161,tz:38,type:'psyche_horror'},
    {tx:172,tz:36,type:'rift_stalker'},
    {tx:163,tz:39,type:'rift_stalker'},
    {tx:169,tz:45,type:'void_colossus'},
    {tx:168,tz:36,type:'void_colossus'},
    {tx:207,tz:70,type:'rift_stalker'},
    {tx:205,tz:69,type:'rift_stalker'},
    {tx:194,tz:71,type:'rift_weaver'},
    {tx:197,tz:69,type:'rift_weaver'},
    {tx:191,tz:79,type:'psyche_horror'},
    {tx:206,tz:70,type:'psyche_horror'},
    {tx:208,tz:80,type:'rift_stalker'},
    {tx:193,tz:67,type:'rift_stalker'},
    {tx:204,tz:73,type:'void_colossus'},
    {tx:198,tz:73,type:'void_colossus'},
    {tx:44,tz:205,type:'rift_stalker'},
    {tx:32,tz:202,type:'rift_stalker'},
    {tx:46,tz:193,type:'rift_weaver'},
    {tx:33,tz:194,type:'rift_weaver'},
    {tx:33,tz:205,type:'psyche_horror'},
    {tx:38,tz:203,type:'psyche_horror'},
    {tx:36,tz:192,type:'rift_stalker'},
    {tx:43,tz:191,type:'rift_stalker'},
    {tx:46,tz:208,type:'void_colossus'},
    {tx:42,tz:197,type:'void_colossus'},
    {tx:64,tz:199,type:'rift_stalker'},
    {tx:81,tz:192,type:'rift_stalker'},
    {tx:81,tz:202,type:'rift_weaver'},
    {tx:81,tz:201,type:'rift_weaver'},
    {tx:74,tz:193,type:'psyche_horror'},
    {tx:69,tz:192,type:'psyche_horror'},
    {tx:76,tz:201,type:'rift_stalker'},
    {tx:78,tz:198,type:'rift_stalker'},
    {tx:73,tz:201,type:'void_colossus'},
    {tx:75,tz:196,type:'void_colossus'},
    {tx:38,tz:174,type:'rift_stalker'},
    {tx:49,tz:177,type:'rift_stalker'},
    {tx:31,tz:176,type:'rift_weaver'},
    {tx:46,tz:169,type:'rift_weaver'},
    {tx:42,tz:164,type:'psyche_horror'},
    {tx:40,tz:166,type:'psyche_horror'},
    {tx:33,tz:167,type:'rift_stalker'},
    {tx:33,tz:174,type:'rift_stalker'},
    {tx:35,tz:172,type:'void_colossus'},
    {tx:46,tz:165,type:'void_colossus'},
    {tx:207,tz:194,type:'rift_stalker'},
    {tx:196,tz:194,type:'rift_stalker'},
    {tx:193,tz:204,type:'rift_weaver'},
    {tx:202,tz:203,type:'rift_weaver'},
    {tx:196,tz:196,type:'psyche_horror'},
    {tx:199,tz:209,type:'psyche_horror'},
    {tx:196,tz:201,type:'rift_stalker'},
    {tx:197,tz:208,type:'rift_stalker'},
    {tx:198,tz:200,type:'void_colossus'},
    {tx:195,tz:205,type:'void_colossus'},
    {tx:174,tz:193,type:'rift_stalker'},
    {tx:175,tz:205,type:'rift_stalker'},
    {tx:162,tz:194,type:'rift_weaver'},
    {tx:163,tz:205,type:'rift_weaver'},
    {tx:176,tz:195,type:'psyche_horror'},
    {tx:161,tz:191,type:'psyche_horror'},
    {tx:172,tz:200,type:'rift_stalker'},
    {tx:177,tz:209,type:'rift_stalker'},
    {tx:160,tz:201,type:'void_colossus'},
    {tx:159,tz:206,type:'void_colossus'},
    {tx:198,tz:162,type:'rift_stalker'},
    {tx:209,tz:164,type:'rift_stalker'},
    {tx:197,tz:166,type:'rift_weaver'},
    {tx:191,tz:171,type:'rift_weaver'},
    {tx:204,tz:171,type:'psyche_horror'},
    {tx:204,tz:164,type:'psyche_horror'},
    {tx:194,tz:169,type:'rift_stalker'},
    {tx:192,tz:160,type:'rift_stalker'},
    {tx:192,tz:161,type:'void_colossus'},
    {tx:196,tz:159,type:'void_colossus'},
    {tx:128,tz:61,type:'rift_stalker'},
    {tx:120,tz:53,type:'rift_stalker'},
    {tx:121,tz:43,type:'rift_weaver'},
    {tx:113,tz:56,type:'rift_weaver'},
    {tx:112,tz:45,type:'psyche_horror'},
    {tx:128,tz:59,type:'psyche_horror'},
    {tx:118,tz:51,type:'rift_stalker'},
    {tx:120,tz:49,type:'rift_stalker'},
    {tx:123,tz:187,type:'rift_stalker'},
    {tx:129,tz:195,type:'rift_stalker'},
    {tx:116,tz:186,type:'rift_weaver'},
    {tx:126,tz:194,type:'rift_weaver'},
    {tx:113,tz:188,type:'psyche_horror'},
    {tx:122,tz:189,type:'psyche_horror'},
    {tx:128,tz:180,type:'rift_stalker'},
    {tx:128,tz:191,type:'rift_stalker'},
    {tx:57,tz:118,type:'rift_stalker'},
    {tx:48,tz:116,type:'rift_stalker'},
    {tx:63,tz:127,type:'rift_weaver'},
    {tx:53,tz:121,type:'rift_weaver'},
    {tx:53,tz:115,type:'psyche_horror'},
    {tx:58,tz:114,type:'psyche_horror'},
    {tx:64,tz:118,type:'rift_stalker'},
    {tx:51,tz:112,type:'rift_stalker'},
    {tx:193,tz:121,type:'rift_stalker'},
    {tx:180,tz:124,type:'rift_stalker'},
    {tx:189,tz:129,type:'rift_weaver'},
    {tx:175,tz:111,type:'rift_weaver'},
    {tx:188,tz:124,type:'psyche_horror'},
    {tx:182,tz:124,type:'psyche_horror'},
    {tx:191,tz:128,type:'rift_stalker'},
    {tx:189,tz:122,type:'rift_stalker'},
    {tx:121,tz:217,type:'psyche_horror'},
    {tx:132,tz:23,type:'rift_weaver'},
    {tx:188,tz:40,type:'psyche_horror'},
    {tx:184,tz:203,type:'rift_weaver'},
    {tx:90,tz:187,type:'psyche_horror'},
    {tx:213,tz:151,type:'rift_weaver'},
    {tx:117,tz:155,type:'psyche_horror'},
    {tx:58,tz:74,type:'rift_weaver'},
    {tx:153,tz:44,type:'psyche_horror'},
    {tx:167,tz:37,type:'rift_weaver'},
    {tx:71,tz:138,type:'psyche_horror'},
    {tx:36,tz:100,type:'rift_weaver'},
    {tx:86,tz:216,type:'psyche_horror'},
    {tx:150,tz:26,type:'rift_weaver'},
    {tx:137,tz:198,type:'psyche_horror'},
    {tx:43,tz:215,type:'rift_weaver'},
    {tx:104,tz:217,type:'psyche_horror'},
    {tx:215,tz:73,type:'rift_weaver'},
    {tx:38,tz:140,type:'psyche_horror'},
    {tx:170,tz:214,type:'rift_weaver'},
    {tx:164,tz:166,type:'psyche_horror'},
    {tx:92,tz:20,type:'rift_weaver'},
    {tx:119,tz:59,type:'psyche_horror'},
    {tx:54,tz:140,type:'rift_weaver'},
    {tx:75,tz:200,type:'rift_weaver'},
    {tx:182,tz:89,type:'rift_weaver'},
    {tx:167,tz:183,type:'rift_weaver'},
    {tx:148,tz:138,type:'rift_weaver'},
  ],
  wyvernwastes: [
    {tx:43,tz:49,type:'wyvern_warlord'},
    {tx:43,tz:36,type:'wyvern_warlord'},
    {tx:37,tz:43,type:'deep_wyrm'},
    {tx:39,tz:39,type:'deep_wyrm'},
    {tx:32,tz:35,type:'elder_dragon'},
    {tx:38,tz:41,type:'elder_dragon'},
    {tx:42,tz:48,type:'wyvern_warlord'},
    {tx:38,tz:32,type:'wyvern_warlord'},
    {tx:36,tz:39,type:'deep_wyrm'},
    {tx:35,tz:36,type:'deep_wyrm'},
    {tx:66,tz:38,type:'wyvern_warlord'},
    {tx:81,tz:46,type:'wyvern_warlord'},
    {tx:73,tz:38,type:'deep_wyrm'},
    {tx:72,tz:43,type:'deep_wyrm'},
    {tx:67,tz:31,type:'elder_dragon'},
    {tx:73,tz:43,type:'elder_dragon'},
    {tx:71,tz:37,type:'wyvern_warlord'},
    {tx:75,tz:45,type:'wyvern_warlord'},
    {tx:74,tz:39,type:'deep_wyrm'},
    {tx:75,tz:46,type:'deep_wyrm'},
    {tx:37,tz:73,type:'wyvern_warlord'},
    {tx:37,tz:81,type:'wyvern_warlord'},
    {tx:41,tz:71,type:'deep_wyrm'},
    {tx:42,tz:65,type:'deep_wyrm'},
    {tx:32,tz:65,type:'elder_dragon'},
    {tx:40,tz:79,type:'elder_dragon'},
    {tx:37,tz:78,type:'wyvern_warlord'},
    {tx:37,tz:67,type:'wyvern_warlord'},
    {tx:47,tz:63,type:'deep_wyrm'},
    {tx:47,tz:79,type:'deep_wyrm'},
    {tx:207,tz:35,type:'wyvern_warlord'},
    {tx:204,tz:39,type:'wyvern_warlord'},
    {tx:194,tz:33,type:'deep_wyrm'},
    {tx:209,tz:43,type:'deep_wyrm'},
    {tx:193,tz:39,type:'elder_dragon'},
    {tx:192,tz:48,type:'elder_dragon'},
    {tx:195,tz:45,type:'wyvern_warlord'},
    {tx:200,tz:39,type:'wyvern_warlord'},
    {tx:198,tz:39,type:'deep_wyrm'},
    {tx:201,tz:32,type:'deep_wyrm'},
    {tx:166,tz:40,type:'wyvern_warlord'},
    {tx:177,tz:34,type:'wyvern_warlord'},
    {tx:168,tz:39,type:'deep_wyrm'},
    {tx:173,tz:42,type:'deep_wyrm'},
    {tx:171,tz:39,type:'elder_dragon'},
    {tx:174,tz:48,type:'elder_dragon'},
    {tx:171,tz:49,type:'wyvern_warlord'},
    {tx:169,tz:44,type:'wyvern_warlord'},
    {tx:159,tz:46,type:'deep_wyrm'},
    {tx:173,tz:36,type:'deep_wyrm'},
    {tx:205,tz:73,type:'wyvern_warlord'},
    {tx:194,tz:76,type:'wyvern_warlord'},
    {tx:192,tz:66,type:'deep_wyrm'},
    {tx:205,tz:78,type:'deep_wyrm'},
    {tx:206,tz:73,type:'elder_dragon'},
    {tx:202,tz:66,type:'elder_dragon'},
    {tx:203,tz:70,type:'wyvern_warlord'},
    {tx:192,tz:70,type:'wyvern_warlord'},
    {tx:204,tz:70,type:'deep_wyrm'},
    {tx:203,tz:68,type:'deep_wyrm'},
    {tx:34,tz:204,type:'wyvern_warlord'},
    {tx:49,tz:206,type:'wyvern_warlord'},
    {tx:47,tz:200,type:'deep_wyrm'},
    {tx:31,tz:201,type:'deep_wyrm'},
    {tx:42,tz:204,type:'elder_dragon'},
    {tx:42,tz:199,type:'elder_dragon'},
    {tx:43,tz:191,type:'wyvern_warlord'},
    {tx:35,tz:208,type:'wyvern_warlord'},
    {tx:49,tz:207,type:'deep_wyrm'},
    {tx:37,tz:198,type:'deep_wyrm'},
    {tx:70,tz:202,type:'wyvern_warlord'},
    {tx:66,tz:203,type:'wyvern_warlord'},
    {tx:63,tz:200,type:'deep_wyrm'},
    {tx:70,tz:207,type:'deep_wyrm'},
    {tx:64,tz:209,type:'elder_dragon'},
    {tx:65,tz:202,type:'elder_dragon'},
    {tx:67,tz:206,type:'wyvern_warlord'},
    {tx:65,tz:192,type:'wyvern_warlord'},
    {tx:75,tz:194,type:'deep_wyrm'},
    {tx:79,tz:193,type:'deep_wyrm'},
    {tx:38,tz:171,type:'wyvern_warlord'},
    {tx:36,tz:165,type:'wyvern_warlord'},
    {tx:46,tz:161,type:'deep_wyrm'},
    {tx:35,tz:166,type:'deep_wyrm'},
    {tx:41,tz:170,type:'elder_dragon'},
    {tx:45,tz:176,type:'elder_dragon'},
    {tx:31,tz:172,type:'wyvern_warlord'},
    {tx:39,tz:168,type:'wyvern_warlord'},
    {tx:31,tz:160,type:'deep_wyrm'},
    {tx:31,tz:171,type:'deep_wyrm'},
    {tx:204,tz:203,type:'wyvern_warlord'},
    {tx:195,tz:205,type:'wyvern_warlord'},
    {tx:194,tz:197,type:'deep_wyrm'},
    {tx:202,tz:203,type:'deep_wyrm'},
    {tx:198,tz:205,type:'elder_dragon'},
    {tx:203,tz:203,type:'elder_dragon'},
    {tx:196,tz:199,type:'wyvern_warlord'},
    {tx:209,tz:204,type:'wyvern_warlord'},
    {tx:202,tz:202,type:'deep_wyrm'},
    {tx:195,tz:207,type:'deep_wyrm'},
    {tx:177,tz:207,type:'wyvern_warlord'},
    {tx:176,tz:201,type:'wyvern_warlord'},
    {tx:169,tz:192,type:'deep_wyrm'},
    {tx:168,tz:208,type:'deep_wyrm'},
    {tx:177,tz:194,type:'elder_dragon'},
    {tx:163,tz:194,type:'elder_dragon'},
    {tx:177,tz:193,type:'wyvern_warlord'},
    {tx:175,tz:209,type:'wyvern_warlord'},
    {tx:160,tz:203,type:'deep_wyrm'},
    {tx:175,tz:192,type:'deep_wyrm'},
    {tx:200,tz:162,type:'wyvern_warlord'},
    {tx:208,tz:161,type:'wyvern_warlord'},
    {tx:205,tz:166,type:'deep_wyrm'},
    {tx:194,tz:172,type:'deep_wyrm'},
    {tx:195,tz:162,type:'elder_dragon'},
    {tx:209,tz:177,type:'elder_dragon'},
    {tx:192,tz:174,type:'wyvern_warlord'},
    {tx:192,tz:177,type:'wyvern_warlord'},
    {tx:208,tz:164,type:'deep_wyrm'},
    {tx:193,tz:159,type:'deep_wyrm'},
    {tx:123,tz:54,type:'wyvern_warlord'},
    {tx:125,tz:51,type:'wyvern_warlord'},
    {tx:113,tz:51,type:'deep_wyrm'},
    {tx:124,tz:52,type:'deep_wyrm'},
    {tx:120,tz:58,type:'elder_dragon'},
    {tx:127,tz:45,type:'elder_dragon'},
    {tx:120,tz:51,type:'wyvern_warlord'},
    {tx:128,tz:54,type:'wyvern_warlord'},
    {tx:111,tz:56,type:'deep_wyrm'},
    {tx:127,tz:44,type:'deep_wyrm'},
    {tx:114,tz:179,type:'wyvern_warlord'},
    {tx:112,tz:188,type:'wyvern_warlord'},
    {tx:115,tz:186,type:'deep_wyrm'},
    {tx:125,tz:186,type:'deep_wyrm'},
    {tx:115,tz:180,type:'elder_dragon'},
    {tx:112,tz:194,type:'elder_dragon'},
    {tx:119,tz:193,type:'wyvern_warlord'},
    {tx:124,tz:192,type:'wyvern_warlord'},
    {tx:125,tz:191,type:'deep_wyrm'},
    {tx:116,tz:187,type:'deep_wyrm'},
    {tx:59,tz:122,type:'wyvern_warlord'},
    {tx:63,tz:117,type:'wyvern_warlord'},
    {tx:64,tz:111,type:'deep_wyrm'},
    {tx:61,tz:115,type:'deep_wyrm'},
    {tx:61,tz:113,type:'elder_dragon'},
    {tx:50,tz:127,type:'elder_dragon'},
    {tx:64,tz:116,type:'wyvern_warlord'},
    {tx:47,tz:111,type:'wyvern_warlord'},
    {tx:54,tz:116,type:'deep_wyrm'},
    {tx:47,tz:117,type:'deep_wyrm'},
    {tx:186,tz:118,type:'wyvern_warlord'},
    {tx:192,tz:116,type:'wyvern_warlord'},
    {tx:183,tz:128,type:'deep_wyrm'},
    {tx:181,tz:129,type:'deep_wyrm'},
    {tx:182,tz:114,type:'elder_dragon'},
    {tx:175,tz:111,type:'elder_dragon'},
    {tx:181,tz:120,type:'wyvern_warlord'},
    {tx:183,tz:119,type:'wyvern_warlord'},
    {tx:185,tz:127,type:'deep_wyrm'},
    {tx:179,tz:115,type:'deep_wyrm'},
    {tx:53,tz:197,type:'wyvern_warlord'},
    {tx:187,tz:86,type:'elder_dragon'},
    {tx:150,tz:43,type:'wyvern_warlord'},
    {tx:216,tz:21,type:'wyvern_warlord'},
    {tx:70,tz:212,type:'elder_dragon'},
    {tx:39,tz:101,type:'wyvern_warlord'},
    {tx:56,tz:28,type:'wyvern_warlord'},
    {tx:42,tz:152,type:'elder_dragon'},
    {tx:41,tz:58,type:'wyvern_warlord'},
    {tx:148,tz:59,type:'wyvern_warlord'},
    {tx:87,tz:119,type:'elder_dragon'},
    {tx:171,tz:200,type:'wyvern_warlord'},
    {tx:180,tz:56,type:'elder_dragon'},
    {tx:58,tz:87,type:'elder_dragon'},
    {tx:120,tz:151,type:'elder_dragon'},
    {tx:197,tz:135,type:'elder_dragon'},
    {tx:100,tz:40,type:'elder_dragon'},
    {tx:118,tz:184,type:'elder_dragon'},
    {tx:148,tz:27,type:'elder_dragon'},
    {tx:133,tz:53,type:'elder_dragon'},
    {tx:107,tz:54,type:'elder_dragon'},
    {tx:154,tz:172,type:'elder_dragon'},
    {tx:86,tz:22,type:'elder_dragon'},
    {tx:187,tz:138,type:'elder_dragon'},
    {tx:90,tz:105,type:'elder_dragon'},
    {tx:197,tz:24,type:'elder_dragon'},
    {tx:169,tz:148,type:'elder_dragon'},
    {tx:44,tz:72,type:'elder_dragon'},
    {tx:214,tz:52,type:'elder_dragon'},
    {tx:37,tz:200,type:'elder_dragon'},
  ],
  xumen: [
  ...
  necropolis: [
    {tx:40,tz:32,type:'necro_wight'},
    {tx:24,tz:33,type:'necro_wight'},
    {tx:24,tz:31,type:'necro_abomination'},
    {tx:28,tz:41,type:'necro_abomination'},
    {tx:25,tz:30,type:'necro_lich_mage'},
    {tx:29,tz:33,type:'necro_lich_mage'},
    {tx:28,tz:23,type:'necro_specter'},
    {tx:24,tz:38,type:'necro_specter'},
    {tx:34,tz:29,type:'necro_wight'},
    {tx:30,tz:34,type:'necro_wight'},
    {tx:56,tz:48,type:'necro_wight'},
    {tx:58,tz:46,type:'necro_wight'},
    {tx:72,tz:35,type:'necro_abomination'},
    {tx:60,tz:32,type:'necro_abomination'},
    {tx:66,tz:47,type:'necro_lich_mage'},
    {tx:64,tz:44,type:'necro_lich_mage'},
    {tx:67,tz:35,type:'necro_specter'},
    {tx:71,tz:40,type:'necro_specter'},
    {tx:63,tz:32,type:'necro_wight'},
    {tx:61,tz:49,type:'necro_wight'},
    {tx:38,tz:73,type:'necro_wight'},
    {tx:38,tz:67,type:'necro_wight'},
    {tx:46,tz:62,type:'necro_abomination'},
    {tx:45,tz:67,type:'necro_abomination'},
    {tx:48,tz:65,type:'necro_lich_mage'},
    {tx:32,tz:75,type:'necro_lich_mage'},
    {tx:45,tz:64,type:'necro_specter'},
    {tx:40,tz:73,type:'necro_specter'},
    {tx:45,tz:63,type:'necro_wight'},
    {tx:37,tz:64,type:'necro_wight'},
    {tx:202,tz:24,type:'necro_wight'},
    {tx:199,tz:25,type:'necro_wight'},
    {tx:203,tz:40,type:'necro_abomination'},
    {tx:199,tz:38,type:'necro_abomination'},
    {tx:213,tz:37,type:'necro_lich_mage'},
    {tx:210,tz:25,type:'necro_lich_mage'},
    {tx:216,tz:24,type:'necro_specter'},
    {tx:209,tz:40,type:'necro_specter'},
    {tx:214,tz:27,type:'necro_wight'},
    {tx:214,tz:39,type:'necro_wight'},
    {tx:177,tz:62,type:'necro_wight'},
    {tx:186,tz:49,type:'necro_wight'},
    {tx:189,tz:49,type:'necro_abomination'},
    {tx:181,tz:53,type:'necro_abomination'},
    {tx:177,tz:56,type:'necro_lich_mage'},
    {tx:181,tz:52,type:'necro_lich_mage'},
    {tx:193,tz:64,type:'necro_specter'},
    {tx:183,tz:58,type:'necro_specter'},
    {tx:189,tz:47,type:'necro_wight'},
    {tx:189,tz:62,type:'necro_wight'},
    {tx:219,tz:78,type:'necro_wight'},
    {tx:209,tz:73,type:'necro_wight'},
    {tx:202,tz:69,type:'necro_abomination'},
    {tx:211,tz:72,type:'necro_abomination'},
    {tx:215,tz:72,type:'necro_lich_mage'},
    {tx:213,tz:80,type:'necro_lich_mage'},
    {tx:213,tz:69,type:'necro_specter'},
    {tx:205,tz:83,type:'necro_specter'},
    {tx:201,tz:83,type:'necro_wight'},
    {tx:201,tz:72,type:'necro_wight'},
    {tx:29,tz:209,type:'necro_wight'},
    {tx:37,tz:208,type:'necro_wight'},
    {tx:25,tz:211,type:'necro_abomination'},
    {tx:35,tz:203,type:'necro_abomination'},
    {tx:40,tz:214,type:'necro_lich_mage'},
    {tx:33,tz:204,type:'necro_lich_mage'},
    {tx:25,tz:207,type:'necro_specter'},
    {tx:24,tz:201,type:'necro_specter'},
    {tx:39,tz:208,type:'necro_wight'},
    {tx:36,tz:204,type:'necro_wight'},
    {tx:55,tz:185,type:'necro_wight'},
    {tx:60,tz:187,type:'necro_wight'},
    {tx:59,tz:181,type:'necro_abomination'},
    {tx:59,tz:176,type:'necro_abomination'},
    {tx:61,tz:180,type:'necro_lich_mage'},
    {tx:50,tz:176,type:'necro_lich_mage'},
    {tx:57,tz:178,type:'necro_specter'},
    {tx:63,tz:187,type:'necro_specter'},
    {tx:55,tz:177,type:'necro_wight'},
    {tx:50,tz:177,type:'necro_wight'},
    {tx:35,tz:210,type:'necro_wight'},
    {tx:37,tz:219,type:'necro_wight'},
    {tx:44,tz:212,type:'necro_abomination'},
    {tx:48,tz:205,type:'necro_abomination'},
    {tx:40,tz:202,type:'necro_lich_mage'},
    {tx:43,tz:217,type:'necro_lich_mage'},
    {tx:34,tz:209,type:'necro_specter'},
    {tx:43,tz:208,type:'necro_specter'},
    {tx:49,tz:208,type:'necro_wight'},
    {tx:46,tz:212,type:'necro_wight'},
    {tx:209,tz:205,type:'necro_wight'},
    {tx:200,tz:199,type:'necro_wight'},
    {tx:215,tz:211,type:'necro_abomination'},
    {tx:209,tz:216,type:'necro_abomination'},
    {tx:206,tz:212,type:'necro_lich_mage'},
    {tx:205,tz:217,type:'necro_lich_mage'},
    {tx:217,tz:201,type:'necro_specter'},
    {tx:215,tz:213,type:'necro_specter'},
    {tx:202,tz:206,type:'necro_wight'},
    {tx:207,tz:214,type:'necro_wight'},
    {tx:182,tz:189,type:'necro_wight'},
    {tx:171,tz:195,type:'necro_wight'},
    {tx:167,tz:191,type:'necro_abomination'},
    {tx:184,tz:193,type:'necro_abomination'},
    {tx:174,tz:192,type:'necro_lich_mage'},
    {tx:183,tz:195,type:'necro_lich_mage'},
    {tx:171,tz:181,type:'necro_specter'},
    {tx:167,tz:185,type:'necro_specter'},
    {tx:173,tz:195,type:'necro_wight'},
    {tx:178,tz:177,type:'necro_wight'},
    {tx:218,tz:176,type:'necro_wight'},
    {tx:201,tz:171,type:'necro_wight'},
    {tx:207,tz:170,type:'necro_abomination'},
    {tx:201,tz:173,type:'necro_abomination'},
    {tx:208,tz:166,type:'necro_lich_mage'},
    {tx:205,tz:169,type:'necro_lich_mage'},
    {tx:219,tz:177,type:'necro_specter'},
    {tx:203,tz:174,type:'necro_specter'},
    {tx:204,tz:178,type:'necro_wight'},
    {tx:207,tz:174,type:'necro_wight'},
    {tx:124,tz:41,type:'necro_wight'},
    {tx:112,tz:45,type:'necro_wight'},
    {tx:122,tz:39,type:'necro_abomination'},
    {tx:122,tz:43,type:'necro_abomination'},
    {tx:127,tz:39,type:'necro_lich_mage'},
    {tx:120,tz:38,type:'necro_lich_mage'},
    {tx:118,tz:42,type:'necro_specter'},
    {tx:116,tz:48,type:'necro_specter'},
    {tx:115,tz:51,type:'necro_wight'},
    {tx:115,tz:44,type:'necro_wight'},
    {tx:127,tz:200,type:'necro_wight'},
    {tx:125,tz:202,type:'necro_wight'},
    {tx:120,tz:197,type:'necro_abomination'},
    {tx:120,tz:195,type:'necro_abomination'},
    {tx:117,tz:199,type:'necro_lich_mage'},
    {tx:115,tz:190,type:'necro_lich_mage'},
    {tx:129,tz:195,type:'necro_specter'},
    {tx:113,tz:196,type:'necro_specter'},
    {tx:112,tz:203,type:'necro_wight'},
    {tx:123,tz:201,type:'necro_wight'},
    {tx:79,tz:124,type:'necro_abomination'},
    {tx:80,tz:124,type:'necro_abomination'},
    {tx:77,tz:126,type:'necro_lich_mage'},
    {tx:63,tz:125,type:'necro_lich_mage'},
    {tx:65,tz:121,type:'necro_specter'},
    {tx:80,tz:127,type:'necro_specter'},
    {tx:164,tz:123,type:'necro_abomination'},
    {tx:166,tz:119,type:'necro_abomination'},
    {tx:159,tz:116,type:'necro_lich_mage'},
    {tx:172,tz:125,type:'necro_lich_mage'},
    {tx:168,tz:128,type:'necro_specter'},
    {tx:159,tz:111,type:'necro_specter'},
    {tx:91,tz:180,type:'necro_specter'},
    {tx:72,tz:42,type:'necro_lich_mage'},
    {tx:117,tz:88,type:'necro_abomination'},
    {tx:219,tz:52,type:'necro_specter'},
    {tx:132,tz:148,type:'necro_lich_mage'},
    {tx:168,tz:52,type:'necro_abomination'},
    {tx:21,tz:169,type:'necro_specter'},
    {tx:105,tz:86,type:'necro_lich_mage'},
    {tx:133,tz:89,type:'necro_abomination'},
    {tx:92,tz:134,type:'necro_specter'},
    {tx:21,tz:36,type:'necro_lich_mage'},
    {tx:152,tz:100,type:'necro_abomination'},
    {tx:204,tz:87,type:'necro_specter'},
    {tx:43,tz:123,type:'necro_lich_mage'},
    {tx:182,tz:42,type:'necro_abomination'},
    {tx:212,tz:70,type:'necro_specter'},
    {tx:181,tz:212,type:'necro_lich_mage'},
    {tx:215,tz:166,type:'necro_abomination'},
    {tx:169,tz:136,type:'necro_specter'},
    {tx:73,tz:60,type:'necro_lich_mage'},
    {tx:118,tz:40,type:'necro_abomination'},
    {tx:180,tz:105,type:'necro_specter'},
    {tx:69,tz:164,type:'necro_lich_mage'},
    {tx:135,tz:164,type:'necro_abomination'},
    {tx:84,tz:54,type:'necro_specter'},
    {tx:180,tz:166,type:'necro_lich_mage'},
    {tx:75,tz:186,type:'necro_abomination'},
    {tx:57,tz:104,type:'necro_specter'},
    {tx:196,tz:27,type:'necro_lich_mage'},
    {tx:58,tz:165,type:'necro_abomination'},
    {tx:41,tz:59,type:'necro_specter'},
    {tx:167,tz:183,type:'necro_lich_mage'},
    {tx:105,tz:201,type:'necro_abomination'},
    {tx:71,tz:72,type:'necro_specter'},
    {tx:155,tz:150,type:'necro_lich_mage'},
    {tx:165,tz:36,type:'necro_abomination'},
    {tx:108,tz:40,type:'necro_abomination'},
    {tx:137,tz:70,type:'necro_abomination'},
    {tx:188,tz:22,type:'necro_abomination'},
    {tx:138,tz:140,type:'necro_abomination'},
  ],
  xumen_fortress: [
    {tx:38,tz:49,type:'xf_titan_elite'},
    {tx:46,tz:32,type:'xf_titan_elite'},
    {tx:38,tz:40,type:'xf_warlord'},
    {tx:42,tz:47,type:'xf_warlord'},
    {tx:35,tz:43,type:'xf_siege_walker'},
    {tx:39,tz:49,type:'xf_siege_walker'},
    {tx:34,tz:33,type:'xf_titan_elite'},
    {tx:46,tz:47,type:'xf_titan_elite'},
    {tx:38,tz:36,type:'xf_fortress_drone'},
    {tx:37,tz:48,type:'xf_fortress_drone'},
    {tx:69,tz:32,type:'xf_titan_elite'},
    {tx:69,tz:31,type:'xf_titan_elite'},
    {tx:74,tz:35,type:'xf_warlord'},
    {tx:64,tz:35,type:'xf_warlord'},
    {tx:79,tz:35,type:'xf_siege_walker'},
    {tx:76,tz:34,type:'xf_siege_walker'},
    {tx:73,tz:37,type:'xf_titan_elite'},
    {tx:79,tz:41,type:'xf_titan_elite'},
    {tx:76,tz:36,type:'xf_fortress_drone'},
    {tx:75,tz:36,type:'xf_fortress_drone'},
    {tx:46,tz:65,type:'xf_titan_elite'},
    {tx:38,tz:64,type:'xf_titan_elite'},
    {tx:42,tz:75,type:'xf_warlord'},
    {tx:36,tz:78,type:'xf_warlord'},
    {tx:49,tz:79,type:'xf_siege_walker'},
    {tx:48,tz:63,type:'xf_siege_walker'},
    {tx:46,tz:78,type:'xf_titan_elite'},
    {tx:42,tz:79,type:'xf_titan_elite'},
    {tx:36,tz:76,type:'xf_fortress_drone'},
    {tx:32,tz:64,type:'xf_fortress_drone'},
    {tx:198,tz:33,type:'xf_titan_elite'},
    {tx:192,tz:34,type:'xf_titan_elite'},
    {tx:204,tz:39,type:'xf_warlord'},
    {tx:200,tz:37,type:'xf_warlord'},
    {tx:192,tz:40,type:'xf_siege_walker'},
    {tx:205,tz:33,type:'xf_siege_walker'},
    {tx:195,tz:35,type:'xf_titan_elite'},
    {tx:200,tz:33,type:'xf_titan_elite'},
    {tx:192,tz:38,type:'xf_fortress_drone'},
    {tx:191,tz:35,type:'xf_fortress_drone'},
    {tx:167,tz:37,type:'xf_titan_elite'},
    {tx:166,tz:42,type:'xf_titan_elite'},
    {tx:169,tz:31,type:'xf_warlord'},
    {tx:162,tz:34,type:'xf_warlord'},
    {tx:159,tz:41,type:'xf_siege_walker'},
    {tx:177,tz:40,type:'xf_siege_walker'},
    {tx:170,tz:33,type:'xf_titan_elite'},
    {tx:159,tz:32,type:'xf_titan_elite'},
    {tx:172,tz:41,type:'xf_fortress_drone'},
    {tx:171,tz:40,type:'xf_fortress_drone'},
    {tx:195,tz:81,type:'xf_titan_elite'},
    {tx:193,tz:81,type:'xf_titan_elite'},
    {tx:202,tz:65,type:'xf_warlord'},
    {tx:198,tz:76,type:'xf_warlord'},
    {tx:206,tz:76,type:'xf_siege_walker'},
    {tx:194,tz:64,type:'xf_siege_walker'},
    {tx:193,tz:70,type:'xf_titan_elite'},
    {tx:207,tz:72,type:'xf_titan_elite'},
    {tx:197,tz:72,type:'xf_fortress_drone'},
    {tx:194,tz:63,type:'xf_fortress_drone'},
    {tx:45,tz:204,type:'xf_titan_elite'},
    {tx:33,tz:195,type:'xf_titan_elite'},
    {tx:38,tz:195,type:'xf_warlord'},
    {tx:35,tz:204,type:'xf_warlord'},
    {tx:31,tz:203,type:'xf_siege_walker'},
    {tx:41,tz:201,type:'xf_siege_walker'},
    {tx:48,tz:201,type:'xf_titan_elite'},
    {tx:45,tz:197,type:'xf_titan_elite'},
    {tx:44,tz:201,type:'xf_fortress_drone'},
    {tx:31,tz:205,type:'xf_fortress_drone'},
    {tx:70,tz:196,type:'xf_titan_elite'},
    {tx:80,tz:196,type:'xf_titan_elite'},
    {tx:76,tz:197,type:'xf_warlord'},
    {tx:75,tz:191,type:'xf_warlord'},
    {tx:63,tz:196,type:'xf_siege_walker'},
    {tx:72,tz:199,type:'xf_siege_walker'},
    {tx:65,tz:207,type:'xf_titan_elite'},
    {tx:65,tz:201,type:'xf_titan_elite'},
    {tx:76,tz:204,type:'xf_fortress_drone'},
    {tx:68,tz:191,type:'xf_fortress_drone'},
    {tx:45,tz:167,type:'xf_titan_elite'},
    {tx:46,tz:168,type:'xf_titan_elite'},
    {tx:32,tz:165,type:'xf_warlord'},
    {tx:40,tz:175,type:'xf_warlord'},
    {tx:48,tz:159,type:'xf_siege_walker'},
    {tx:44,tz:174,type:'xf_siege_walker'},
    {tx:35,tz:174,type:'xf_titan_elite'},
    {tx:33,tz:172,type:'xf_titan_elite'},
    {tx:42,tz:162,type:'xf_fortress_drone'},
    {tx:43,tz:175,type:'xf_fortress_drone'},
    {tx:200,tz:202,type:'xf_titan_elite'},
    {tx:208,tz:199,type:'xf_titan_elite'},
    {tx:196,tz:197,type:'xf_warlord'},
    {tx:209,tz:194,type:'xf_warlord'},
    {tx:202,tz:208,type:'xf_siege_walker'},
    {tx:199,tz:207,type:'xf_siege_walker'},
    {tx:203,tz:199,type:'xf_titan_elite'},
    {tx:197,tz:206,type:'xf_titan_elite'},
    {tx:203,tz:206,type:'xf_fortress_drone'},
    {tx:192,tz:208,type:'xf_fortress_drone'},
    {tx:162,tz:206,type:'xf_titan_elite'},
    {tx:160,tz:206,type:'xf_titan_elite'},
    {tx:160,tz:199,type:'xf_warlord'},
    {tx:170,tz:196,type:'xf_warlord'},
    {tx:174,tz:206,type:'xf_siege_walker'},
    {tx:175,tz:194,type:'xf_siege_walker'},
    {tx:173,tz:208,type:'xf_titan_elite'},
    {tx:160,tz:191,type:'xf_titan_elite'},
    {tx:176,tz:195,type:'xf_fortress_drone'},
    {tx:177,tz:195,type:'xf_fortress_drone'},
    {tx:196,tz:170,type:'xf_titan_elite'},
    {tx:209,tz:161,type:'xf_titan_elite'},
    {tx:208,tz:171,type:'xf_warlord'},
    {tx:199,tz:167,type:'xf_warlord'},
    {tx:205,tz:168,type:'xf_siege_walker'},
    {tx:209,tz:160,type:'xf_siege_walker'},
    {tx:193,tz:175,type:'xf_titan_elite'},
    {tx:193,tz:163,type:'xf_titan_elite'},
    {tx:200,tz:166,type:'xf_fortress_drone'},
    {tx:209,tz:173,type:'xf_fortress_drone'},
    {tx:128,tz:56,type:'xf_titan_elite'},
    {tx:126,tz:57,type:'xf_titan_elite'},
    {tx:111,tz:60,type:'xf_warlord'},
    {tx:118,tz:44,type:'xf_warlord'},
    {tx:119,tz:50,type:'xf_siege_walker'},
    {tx:125,tz:52,type:'xf_siege_walker'},
    {tx:111,tz:53,type:'xf_titan_elite'},
    {tx:127,tz:54,type:'xf_titan_elite'},
    {tx:119,tz:44,type:'xf_fortress_drone'},
    {tx:124,tz:57,type:'xf_fortress_drone'},
    {tx:120,tz:182,type:'xf_titan_elite'},
    {tx:122,tz:191,type:'xf_titan_elite'},
    {tx:126,tz:194,type:'xf_warlord'},
    {tx:114,tz:196,type:'xf_warlord'},
    {tx:119,tz:182,type:'xf_siege_walker'},
    {tx:125,tz:179,type:'xf_siege_walker'},
    {tx:112,tz:180,type:'xf_titan_elite'},
    {tx:115,tz:190,type:'xf_titan_elite'},
    {tx:118,tz:190,type:'xf_fortress_drone'},
    {tx:114,tz:190,type:'xf_fortress_drone'},
    {tx:61,tz:116,type:'xf_titan_elite'},
    {tx:53,tz:111,type:'xf_titan_elite'},
    {tx:50,tz:127,type:'xf_warlord'},
    {tx:48,tz:112,type:'xf_warlord'},
    {tx:60,tz:114,type:'xf_siege_walker'},
    {tx:49,tz:123,type:'xf_siege_walker'},
    {tx:50,tz:128,type:'xf_titan_elite'},
    {tx:51,tz:113,type:'xf_titan_elite'},
    {tx:65,tz:112,type:'xf_fortress_drone'},
    {tx:65,tz:115,type:'xf_fortress_drone'},
    {tx:189,tz:119,type:'xf_titan_elite'},
    {tx:178,tz:125,type:'xf_titan_elite'},
    {tx:176,tz:127,type:'xf_warlord'},
    {tx:180,tz:118,type:'xf_warlord'},
    {tx:180,tz:129,type:'xf_siege_walker'},
    {tx:187,tz:119,type:'xf_siege_walker'},
    {tx:183,tz:115,type:'xf_fortress_drone'},
    {tx:177,tz:119,type:'xf_fortress_drone'},
    {tx:98,tz:68,type:'xf_siege_walker'},
    {tx:157,tz:161,type:'xf_warlord'},
    {tx:203,tz:52,type:'xf_fortress_drone'},
    {tx:72,tz:127,type:'xf_siege_walker'},
    {tx:36,tz:176,type:'xf_warlord'},
    {tx:20,tz:84,type:'xf_fortress_drone'},
    {tx:117,tz:155,type:'xf_siege_walker'},
    {tx:98,tz:98,type:'xf_warlord'},
    {tx:215,tz:146,type:'xf_fortress_drone'},
    {tx:71,tz:186,type:'xf_siege_walker'},
    {tx:203,tz:132,type:'xf_warlord'},
    {tx:155,tz:145,type:'xf_fortress_drone'},
    {tx:222,tz:38,type:'xf_siege_walker'},
    {tx:118,tz:26,type:'xf_warlord'},
    {tx:188,tz:157,type:'xf_fortress_drone'},
    {tx:70,tz:172,type:'xf_siege_walker'},
    {tx:66,tz:72,type:'xf_warlord'},
    {tx:188,tz:28,type:'xf_fortress_drone'},
    {tx:223,tz:125,type:'xf_siege_walker'},
    {tx:205,tz:40,type:'xf_warlord'},
    {tx:100,tz:143,type:'xf_siege_walker'},
    {tx:66,tz:37,type:'xf_warlord'},
    {tx:188,tz:117,type:'xf_siege_walker'},
    {tx:175,tz:163,type:'xf_warlord'},
    {tx:186,tz:97,type:'xf_siege_walker'},
    {tx:102,tz:188,type:'xf_warlord'},
    {tx:144,tz:97,type:'xf_siege_walker'},
    {tx:57,tz:131,type:'xf_warlord'},
    {tx:161,tz:86,type:'xf_siege_walker'},
    {tx:126,tz:206,type:'xf_warlord'},
    {tx:162,tz:203,type:'xf_siege_walker'},
    {tx:170,tz:217,type:'xf_warlord'},
    {tx:99,tz:28,type:'xf_siege_walker'},
    {tx:35,tz:126,type:'xf_warlord'},
    {tx:142,tz:161,type:'xf_siege_walker'},
    {tx:25,tz:97,type:'xf_warlord'},
    {tx:67,tz:98,type:'xf_siege_walker'},
    {tx:132,tz:87,type:'xf_warlord'},
    {tx:132,tz:51,type:'xf_warlord'},
    {tx:97,tz:39,type:'xf_warlord'},
    {tx:156,tz:56,type:'xf_warlord'},
    {tx:208,tz:192,type:'xf_warlord'},
  ],
  fungal: [
    // camp 01 [grove guard]
    {tx:145,tz:142,type:'mycelium_horror'},
    {tx:146,tz:140,type:'mycelium_horror'},
    // camp 02 [grove guard]
    {tx:126,tz:88,type:'mycelium_horror'},
    {tx:125,tz:86,type:'mycelium_horror'},
    // camp 03 [grove guard]
    {tx:139,tz:150,type:'mycelium_horror'},
    {tx:136,tz:152,type:'mycelium_horror'},
    // camp 04 [grove guard]
    {tx:151,tz:98,type:'mycelium_horror'},
    {tx:150,tz:100,type:'mycelium_horror'},
    // camp 05 [grove guard]
    {tx:157,tz:126,type:'mycelium_horror'},
    {tx:158,tz:124,type:'mycelium_horror'},
    // camp 06 [grove guard]
    {tx:125,tz:159,type:'mycelium_horror'},
    {tx:125,tz:162,type:'mycelium_horror'},
    // camp 07 [grove guard]
    {tx:80,tz:108,type:'mycelium_horror'},
    {tx:82,tz:108,type:'mycelium_horror'},
    // camp 08 [grove guard]
    {tx:92,tz:86,type:'mycelium_horror'},
    {tx:95,tz:88,type:'mycelium_horror'},
    // camp 09 [grove guard]
    {tx:146,tz:88,type:'mycelium_horror'},
    {tx:145,tz:84,type:'mycelium_horror'},
    // camp 10 [grove guard]
    {tx:96,tz:155,type:'mycelium_horror'},
    {tx:95,tz:155,type:'mycelium_horror'},
    // camp 11 [grove guard]
    {tx:76,tz:123,type:'mycelium_horror'},
    {tx:76,tz:124,type:'mycelium_horror'},
    // camp 12 [grove guard]
    {tx:158,tz:139,type:'mycelium_horror'},
    {tx:161,tz:141,type:'mycelium_horror'},
    // camp 13 [grove guard]
    {tx:81,tz:144,type:'mycelium_horror'},
    {tx:77,tz:144,type:'mycelium_horror'},
    // camp 14 [grove guard]
    {tx:80,tz:88,type:'mycelium_horror'},
    {tx:83,tz:86,type:'mycelium_horror'},
    // camp 15 [grove guard]
    {tx:69,tz:120,type:'mycelium_horror'},
    {tx:70,tz:121,type:'mycelium_horror'},
    // camp 16 [grove guard]
    {tx:173,tz:106,type:'mycelium_horror'},
    {tx:171,tz:109,type:'mycelium_horror'},
    // camp 17 [grove guard]
    {tx:79,tz:154,type:'mycelium_horror'},
    {tx:80,tz:154,type:'mycelium_horror'},
    // camp 18 [grove guard]
    {tx:70,tz:102,type:'mycelium_horror'},
    {tx:68,tz:100,type:'mycelium_horror'},
    // camp 19 [grove guard]
    {tx:172,tz:137,type:'fungal_shambler'},
    {tx:171,tz:139,type:'fungal_shambler'},
    // camp 20 [grove guard]
    {tx:127,tz:177,type:'fungal_shambler'},
    {tx:126,tz:177,type:'fungal_shambler'},
    // camp 21 [grove guard]
    {tx:162,tz:83,type:'fungal_shambler'},
    {tx:164,tz:81,type:'fungal_shambler'},
    // camp 22 [grove guard]
    {tx:141,tz:63,type:'fungal_shambler'},
    {tx:143,tz:63,type:'fungal_shambler'},
    // camp 23 [grove guard]
    {tx:136,tz:179,type:'fungal_shambler'},
    {tx:139,tz:179,type:'fungal_shambler'},
    // camp 24 [grove guard]
    {tx:165,tz:163,type:'fungal_shambler'},
    {tx:166,tz:163,type:'fungal_shambler'},
    // camp 25 [grove guard]
    {tx:182,tz:120,type:'fungal_shambler'},
    {tx:183,tz:117,type:'fungal_shambler'},
    // camp 26 [grove guard]
    {tx:95,tz:61,type:'fungal_shambler'},
    {tx:95,tz:63,type:'fungal_shambler'},
    // camp 27 [grove guard]
    {tx:66,tz:85,type:'fungal_shambler'},
    {tx:66,tz:86,type:'fungal_shambler'},
    // camp 28 [grove guard]
    {tx:111,tz:55,type:'fungal_shambler'},
    {tx:112,tz:56,type:'fungal_shambler'},
    // camp 29 [grove guard]
    {tx:83,tz:175,type:'fungal_shambler'},
    {tx:84,tz:174,type:'fungal_shambler'},
    // camp 30 [grove guard]
    {tx:157,tz:174,type:'fungal_shambler'},
    {tx:159,tz:171,type:'fungal_shambler'},
    // camp 31 [grove guard]
    {tx:59,tz:142,type:'fungal_shambler'},
    {tx:58,tz:144,type:'fungal_shambler'},
    // camp 32 [grove guard]
    {tx:97,tz:182,type:'fungal_shambler'},
    {tx:99,tz:182,type:'fungal_shambler'},
    // camp 33 [grove guard]
    {tx:175,tz:80,type:'fungal_shambler'},
    {tx:174,tz:79,type:'fungal_shambler'},
    // camp 34 [grove guard]
    {tx:62,tz:156,type:'fungal_shambler'},
    {tx:61,tz:157,type:'fungal_shambler'},
    // camp 35 [grove guard]
    {tx:179,tz:161,type:'fungal_shambler'},
    {tx:178,tz:159,type:'fungal_shambler'},
    // camp 36 [grove guard]
    {tx:83,tz:60,type:'fungal_shambler'},
    {tx:81,tz:58,type:'fungal_shambler'},
    // camp 37 [grove guard]
    {tx:116,tz:193,type:'fungal_shambler'},
    {tx:118,tz:193,type:'fungal_shambler'},
    // camp 38 [grove guard]
    {tx:48,tz:100,type:'fungal_shambler'},
    {tx:47,tz:98,type:'fungal_shambler'},
    // camp 39 [grove guard]
    {tx:100,tz:49,type:'fungal_shambler'},
    {tx:100,tz:50,type:'fungal_shambler'},
    // camp 40 [grove guard]
    {tx:142,tz:51,type:'fungal_shambler'},
    // camp 41 [grove guard]
    {tx:171,tz:176,type:'fungal_shambler'},
    // camp 42 [grove guard]
    {tx:163,tz:58,type:'mushroom_man'},
    // camp 43 [grove guard]
    {tx:196,tz:117,type:'mushroom_man'},
    // camp 44 [grove guard]
    {tx:195,tz:106,type:'mushroom_man'},
    // camp 45 [grove guard]
    {tx:40,tz:127,type:'mushroom_man'},
    // camp 46 [grove guard]
    {tx:199,tz:134,type:'mushroom_man'},
    // camp 47 [grove guard]
    {tx:190,tz:82,type:'mushroom_man'},
    // camp 48 [grove guard]
    {tx:128,tz:39,type:'mushroom_man'},
    // camp 49 [grove guard]
    {tx:40,tz:137,type:'mushroom_man'},
    // camp 50 [grove guard]
    {tx:141,tz:202,type:'mushroom_man'},
    // camp 51 [mushroom forest]
    {tx:96,tz:201,type:'mushroom_man'},
    // camp 52 [mushroom forest]
    {tx:38,tz:153,type:'mushroom_man'},
    // camp 53 [mushroom forest]
    {tx:180,tz:55,type:'mushroom_man'},
    // camp 54 [mushroom forest]
    {tx:58,tz:179,type:'mushroom_man'},
    // camp 55 [mushroom forest]
    {tx:84,tz:39,type:'mushroom_man'},
    // camp 56 [mushroom forest]
    {tx:79,tz:195,type:'mushroom_man'},
    // camp 57 [mushroom forest]
    {tx:152,tz:39,type:'mushroom_man'},
    // camp 58 [mushroom forest]
    {tx:57,tz:57,type:'mushroom_man'},
    // camp 59 [mushroom forest]
    {tx:171,tz:192,type:'mushroom_man'},
    // camp 60 [mushroom forest]
    {tx:49,tz:174,type:'mushroom_man'},
    // camp 61 [mushroom forest]
    {tx:38,tz:86,type:'mushroom_man'},
    // camp 62 [mushroom forest]
    {tx:202,tz:162,type:'mushroom_man'},
    // camp 63 [mushroom forest]
    {tx:191,tz:178,type:'mushroom_man'},
    // camp 64 [mushroom forest]
    {tx:213,tz:98,type:'mushroom_man'},
    // camp 65 [mushroom forest]
    {tx:165,tz:203,type:'mushroom_man'},
    // camp 66 [mushroom forest]
    {tx:97,tz:27,type:'mushroom_man'},
    // camp 67 [mushroom forest]
    {tx:25,tz:127,type:'mushroom_man'},
    // camp 68 [mushroom forest]
    {tx:174,tz:40,type:'mushroom_man'},
    // camp 69 [mushroom forest]
    {tx:141,tz:25,type:'mushroom_man'},
    // camp 70 [mushroom forest]
    {tx:196,tz:59,type:'mushroom_man'},
    // camp 71 [mushroom forest]
    {tx:216,tz:130,type:'mushroom_man'},
    // camp 72 [mushroom forest]
    {tx:87,tz:31,type:'mushroom_man'},
    // camp 73 [mushroom forest]
    {tx:23,tz:104,type:'mushroom_man'},
    // camp 74 [mushroom forest]
    {tx:23,tz:135,type:'mushroom_man'},
    // camp 75 [mushroom forest]
    {tx:112,tz:218,type:'mushroom_man'},
    // camp 76 [mushroom forest]
    {tx:161,tz:32,type:'mushroom_man'},
    // camp 77 [mushroom forest]
    {tx:65,tz:203,type:'mushroom_man'},
    // camp 78 [mushroom forest]
    {tx:39,tz:59,type:'spore_walker'},
    // camp 79 [mushroom forest]
    {tx:103,tz:218,type:'spore_walker'},
    // camp 80 [mushroom forest]
    {tx:30,tz:74,type:'spore_walker'},
    // camp 81 [mushroom forest]
    {tx:30,tz:162,type:'spore_walker'},
    // camp 82 [mushroom forest]
    {tx:190,tz:48,type:'spore_walker'},
    // camp 83 [mushroom forest]
    {tx:215,tz:159,type:'spore_walker'},
    // camp 84 [mushroom forest]
    {tx:85,tz:218,type:'spore_walker'},
    // camp 85 [mushroom forest]
    {tx:56,tz:37,type:'spore_walker'},
    // camp 86 [mushroom forest]
    {tx:159,tz:215,type:'spore_walker'},
    // camp 87 [mushroom forest]
    {tx:136,tz:222,type:'spore_walker'},
    // camp 88 [mushroom forest]
    {tx:43,tz:195,type:'spore_walker'},
    // camp 89 [mushroom forest]
    {tx:221,tz:84,type:'spore_walker'},
    // camp 90 [mushroom forest]
    {tx:44,tz:44,type:'spore_walker'},
    // camp 91 [mushroom forest]
    {tx:172,tz:216,type:'spore_walker'},
    // camp 92 [mushroom forest]
    {tx:69,tz:24,type:'spore_walker'},
    // camp 93 [mushroom forest]
    {tx:212,tz:182,type:'spore_walker'},
    // camp 94 [mushroom forest]
    {tx:201,tz:199,type:'spore_walker'},
    // camp 95 [mushroom forest]
    {tx:23,tz:178,type:'spore_walker'},
    // camp 96 [mushroom forest]
    {tx:66,tz:222,type:'spore_walker'},
    // camp 97 [mushroom forest]
    {tx:24,tz:60,type:'spore_walker'},
    // camp 98 [mushroom forest]
    {tx:217,tz:59,type:'spore_walker'},
    // camp 99 [mushroom forest]
    {tx:174,tz:17,type:'spore_walker'},
    // camp 100 [mushroom forest]
    {tx:48,tz:215,type:'spore_walker'},
    // camp 101 [mushroom forest]
    {tx:28,tz:42,type:'spore_walker'},
    // camp 102 [mushroom forest]
    {tx:213,tz:44,type:'spore_walker'},
    // camp 103 [mushroom forest]
    {tx:30,tz:195,type:'spore_walker'},
    // camp 104 [mushroom forest]
    {tx:44,tz:28,type:'spore_walker'},
    // camp 105 [mushroom forest]
    {tx:191,tz:224,type:'spore_walker'},
    // camp 106 [mushroom forest]
    {tx:205,tz:25,type:'spore_walker'},
    // camp 107 [mushroom forest]
    {tx:222,tz:202,type:'spore_walker'},
    // camp 108 [mushroom forest]
    {tx:29,tz:23,type:'spore_walker'},
    // camp 109 [mushroom forest]
    {tx:215,tz:24,type:'spore_walker'},
    // camp 110 [mushroom forest]
  ...
  void_citadel: [
    {tx:44,tz:31,type:'void_construct'},
    {tx:46,tz:35,type:'void_construct'},
    {tx:44,tz:39,type:'void_sentinel'},
    {tx:36,tz:44,type:'void_sentinel'},
    {tx:49,tz:42,type:'rift_stalker'},
    {tx:44,tz:46,type:'rift_stalker'},
    {tx:33,tz:48,type:'void_construct'},
    {tx:42,tz:41,type:'void_construct'},
    {tx:37,tz:36,type:'rift_weaver'},
    {tx:47,tz:48,type:'rift_weaver'},
    {tx:67,tz:37,type:'void_construct'},
    {tx:79,tz:38,type:'void_construct'},
    {tx:73,tz:39,type:'void_sentinel'},
    {tx:80,tz:44,type:'void_sentinel'},
    {tx:81,tz:43,type:'rift_stalker'},
    {tx:71,tz:33,type:'rift_stalker'},
    {tx:67,tz:48,type:'void_construct'},
    {tx:64,tz:49,type:'void_construct'},
    {tx:69,tz:40,type:'rift_weaver'},
    {tx:65,tz:44,type:'rift_weaver'},
    {tx:31,tz:66,type:'void_construct'},
    {tx:49,tz:78,type:'void_construct'},
    {tx:32,tz:69,type:'void_sentinel'},
    {tx:31,tz:75,type:'void_sentinel'},
    {tx:40,tz:74,type:'rift_stalker'},
    {tx:48,tz:72,type:'rift_stalker'},
    {tx:37,tz:75,type:'void_construct'},
    {tx:34,tz:64,type:'void_construct'},
    {tx:48,tz:68,type:'rift_weaver'},
    {tx:40,tz:76,type:'rift_weaver'},
    {tx:196,tz:44,type:'void_construct'},
    {tx:209,tz:42,type:'void_construct'},
    {tx:195,tz:49,type:'void_sentinel'},
    {tx:199,tz:41,type:'void_sentinel'},
    {tx:202,tz:41,type:'rift_stalker'},
    {tx:200,tz:43,type:'rift_stalker'},
    {tx:198,tz:48,type:'void_construct'},
    {tx:208,tz:36,type:'void_construct'},
    {tx:200,tz:41,type:'rift_weaver'},
    {tx:194,tz:46,type:'rift_weaver'},
    {tx:160,tz:37,type:'void_construct'},
    {tx:166,tz:32,type:'void_construct'},
    {tx:163,tz:48,type:'void_sentinel'},
    {tx:164,tz:44,type:'void_sentinel'},
    {tx:174,tz:31,type:'rift_stalker'},
    {tx:169,tz:46,type:'rift_stalker'},
    {tx:173,tz:38,type:'void_construct'},
    {tx:169,tz:39,type:'void_construct'},
    {tx:168,tz:42,type:'rift_weaver'},
    {tx:174,tz:49,type:'rift_weaver'},
    {tx:193,tz:68,type:'void_construct'},
    {tx:203,tz:64,type:'void_construct'},
    {tx:194,tz:80,type:'void_sentinel'},
    {tx:194,tz:76,type:'void_sentinel'},
    {tx:206,tz:77,type:'rift_stalker'},
    {tx:195,tz:79,type:'rift_stalker'},
    {tx:196,tz:65,type:'void_construct'},
    {tx:196,tz:73,type:'void_construct'},
    {tx:203,tz:80,type:'rift_weaver'},
    {tx:196,tz:69,type:'rift_weaver'},
    {tx:36,tz:201,type:'void_construct'},
    {tx:36,tz:203,type:'void_construct'},
    {tx:36,tz:204,type:'void_sentinel'},
    {tx:49,tz:200,type:'void_sentinel'},
    {tx:43,tz:204,type:'rift_stalker'},
    {tx:39,tz:205,type:'rift_stalker'},
    {tx:44,tz:203,type:'void_construct'},
    {tx:42,tz:201,type:'void_construct'},
    {tx:35,tz:209,type:'rift_weaver'},
    {tx:43,tz:194,type:'rift_weaver'},
    {tx:69,tz:205,type:'void_construct'},
    {tx:70,tz:205,type:'void_construct'},
    {tx:80,tz:196,type:'void_sentinel'},
    {tx:65,tz:192,type:'void_sentinel'},
    {tx:71,tz:205,type:'rift_stalker'},
    {tx:65,tz:193,type:'rift_stalker'},
    {tx:78,tz:201,type:'void_construct'},
    {tx:70,tz:202,type:'void_construct'},
    {tx:79,tz:207,type:'rift_weaver'},
    {tx:75,tz:205,type:'rift_weaver'},
    {tx:44,tz:177,type:'void_construct'},
    {tx:48,tz:159,type:'void_construct'},
    {tx:36,tz:174,type:'void_sentinel'},
    {tx:33,tz:171,type:'void_sentinel'},
    {tx:47,tz:169,type:'rift_stalker'},
    {tx:43,tz:161,type:'rift_stalker'},
    {tx:44,tz:163,type:'void_construct'},
    {tx:40,tz:167,type:'void_construct'},
    {tx:38,tz:176,type:'rift_weaver'},
    {tx:41,tz:166,type:'rift_weaver'},
    {tx:200,tz:202,type:'void_construct'},
    {tx:202,tz:209,type:'void_construct'},
    {tx:203,tz:197,type:'void_sentinel'},
    {tx:206,tz:198,type:'void_sentinel'},
    {tx:200,tz:195,type:'rift_stalker'},
    {tx:209,tz:193,type:'rift_stalker'},
    {tx:198,tz:208,type:'void_construct'},
    {tx:194,tz:192,type:'void_construct'},
    {tx:204,tz:192,type:'rift_weaver'},
    {tx:209,tz:206,type:'rift_weaver'},
    {tx:161,tz:209,type:'void_construct'},
    {tx:176,tz:201,type:'void_construct'},
    {tx:169,tz:196,type:'void_sentinel'},
    {tx:166,tz:204,type:'void_sentinel'},
    {tx:171,tz:205,type:'rift_stalker'},
    {tx:173,tz:205,type:'rift_stalker'},
    {tx:176,tz:209,type:'void_construct'},
    {tx:164,tz:207,type:'void_construct'},
    {tx:168,tz:193,type:'rift_weaver'},
    {tx:176,tz:193,type:'rift_weaver'},
    {tx:199,tz:170,type:'void_construct'},
    {tx:193,tz:165,type:'void_construct'},
    {tx:209,tz:171,type:'void_sentinel'},
    {tx:200,tz:177,type:'void_sentinel'},
    {tx:194,tz:159,type:'rift_stalker'},
    {tx:203,tz:168,type:'rift_stalker'},
    {tx:199,tz:161,type:'void_construct'},
    {tx:196,tz:174,type:'void_construct'},
    {tx:200,tz:162,type:'rift_weaver'},
    {tx:204,tz:166,type:'rift_weaver'},
    {tx:117,tz:50,type:'void_construct'},
    {tx:113,tz:58,type:'void_construct'},
    {tx:126,tz:53,type:'void_sentinel'},
    {tx:123,tz:57,type:'void_sentinel'},
    {tx:124,tz:54,type:'rift_stalker'},
    {tx:116,tz:52,type:'rift_stalker'},
    {tx:129,tz:56,type:'void_construct'},
    {tx:115,tz:48,type:'void_construct'},
    {tx:117,tz:43,type:'rift_weaver'},
    {tx:120,tz:44,type:'rift_weaver'},
    {tx:126,tz:189,type:'void_construct'},
    {tx:121,tz:182,type:'void_construct'},
    {tx:112,tz:191,type:'void_sentinel'},
    {tx:115,tz:196,type:'void_sentinel'},
    {tx:119,tz:185,type:'rift_stalker'},
    {tx:127,tz:185,type:'rift_stalker'},
    {tx:121,tz:197,type:'void_construct'},
    {tx:121,tz:192,type:'void_construct'},
    {tx:117,tz:184,type:'rift_weaver'},
    {tx:129,tz:191,type:'rift_weaver'},
    {tx:51,tz:118,type:'void_construct'},
    {tx:65,tz:123,type:'void_construct'},
    {tx:54,tz:124,type:'void_sentinel'},
    {tx:48,tz:124,type:'void_sentinel'},
    {tx:64,tz:123,type:'rift_stalker'},
    {tx:49,tz:115,type:'rift_stalker'},
    {tx:63,tz:121,type:'void_construct'},
    {tx:65,tz:115,type:'void_construct'},
    {tx:60,tz:111,type:'rift_weaver'},
    {tx:53,tz:113,type:'rift_weaver'},
    {tx:180,tz:121,type:'void_construct'},
    {tx:178,tz:116,type:'void_construct'},
    {tx:177,tz:120,type:'void_sentinel'},
    {tx:176,tz:111,type:'void_sentinel'},
    {tx:190,tz:115,type:'rift_stalker'},
    {tx:184,tz:116,type:'rift_stalker'},
    {tx:186,tz:124,type:'void_construct'},
    {tx:181,tz:114,type:'void_construct'},
    {tx:178,tz:127,type:'rift_weaver'},
    {tx:184,tz:118,type:'rift_weaver'},
    {tx:148,tz:160,type:'void_construct'},
    {tx:140,tz:98,type:'void_sentinel'},
    {tx:52,tz:118,type:'rift_stalker'},
    {tx:218,tz:224,type:'rift_weaver'},
    {tx:104,tz:166,type:'void_construct'},
    {tx:182,tz:208,type:'void_sentinel'},
    {tx:109,tz:67,type:'rift_stalker'},
    {tx:121,tz:70,type:'rift_weaver'},
    {tx:94,tz:148,type:'void_sentinel'},
    {tx:220,tz:39,type:'rift_stalker'},
    {tx:26,tz:218,type:'void_sentinel'},
    {tx:224,tz:49,type:'rift_stalker'},
    {tx:182,tz:217,type:'void_sentinel'},
    {tx:203,tz:149,type:'rift_stalker'},
    {tx:119,tz:161,type:'void_sentinel'},
    {tx:79,tz:150,type:'rift_stalker'},
    {tx:95,tz:39,type:'void_sentinel'},
    {tx:160,tz:79,type:'rift_stalker'},
    {tx:21,tz:55,type:'void_sentinel'},
    {tx:84,tz:67,type:'rift_stalker'},
    {tx:192,tz:153,type:'void_sentinel'},
    {tx:108,tz:193,type:'void_sentinel'},
    {tx:216,tz:160,type:'void_sentinel'},
    {tx:221,tz:27,type:'void_sentinel'},
    {tx:53,tz:206,type:'void_sentinel'},
    {tx:54,tz:56,type:'void_sentinel'},
    {tx:209,tz:133,type:'void_sentinel'},
    {tx:96,tz:51,type:'void_sentinel'},
    {tx:91,tz:94,type:'void_sentinel'},
    {tx:53,tz:134,type:'void_sentinel'},
    {tx:95,tz:82,type:'void_sentinel'},
    {tx:164,tz:138,type:'void_sentinel'},
    {tx:36,tz:34,type:'void_sentinel'},
    {tx:138,tz:178,type:'void_sentinel'},
    {tx:204,tz:162,type:'void_sentinel'},
    {tx:176,tz:65,type:'void_sentinel'},
    {tx:216,tz:65,type:'void_sentinel'},
    {tx:193,tz:49,type:'void_sentinel'},
    {tx:53,tz:181,type:'void_sentinel'},
    {tx:26,tz:146,type:'void_sentinel'},
    {tx:76,tz:91,type:'void_sentinel'},
    {tx:137,tz:68,type:'void_sentinel'},
    {tx:124,tz:217,type:'void_sentinel'},
    {tx:149,tz:177,type:'void_sentinel'},
  ],
  // ── NEON HOLLOW — POST-CAP AA-GATED (matches client ZONE_DEFS.neon_hollow) ──
  neon_hollow: [
    {tx:33,tz:34,type:'hollow_enforcer'},
    {tx:34,tz:37,type:'hollow_enforcer'},
    {tx:45,tz:46,type:'maintenance_striker'},
    {tx:37,tz:36,type:'maintenance_striker'},
    {tx:47,tz:41,type:'sentinel_drone'},
    {tx:41,tz:33,type:'sentinel_drone'},
    {tx:31,tz:36,type:'neon_wraith'},
    {tx:49,tz:41,type:'neon_wraith'},
    {tx:44,tz:46,type:'skybridge_sniper'},
    {tx:37,tz:39,type:'skybridge_sniper'},
    {tx:73,tz:47,type:'hollow_enforcer'},
    {tx:76,tz:38,type:'hollow_enforcer'},
    {tx:66,tz:37,type:'maintenance_striker'},
    {tx:63,tz:44,type:'maintenance_striker'},
    {tx:67,tz:47,type:'sentinel_drone'},
    {tx:68,tz:42,type:'sentinel_drone'},
    {tx:74,tz:49,type:'neon_wraith'},
    {tx:76,tz:42,type:'neon_wraith'},
    {tx:78,tz:37,type:'skybridge_sniper'},
    {tx:67,tz:43,type:'skybridge_sniper'},
    {tx:41,tz:76,type:'hollow_enforcer'},
    {tx:49,tz:72,type:'hollow_enforcer'},
    {tx:40,tz:76,type:'maintenance_striker'},
    {tx:34,tz:81,type:'maintenance_striker'},
    {tx:38,tz:77,type:'sentinel_drone'},
    {tx:33,tz:81,type:'sentinel_drone'},
    {tx:33,tz:63,type:'neon_wraith'},
    {tx:38,tz:73,type:'neon_wraith'},
    {tx:44,tz:63,type:'skybridge_sniper'},
    {tx:37,tz:67,type:'skybridge_sniper'},
    {tx:196,tz:33,type:'hollow_enforcer'},
    {tx:206,tz:35,type:'hollow_enforcer'},
    {tx:193,tz:38,type:'maintenance_striker'},
    {tx:194,tz:37,type:'maintenance_striker'},
    {tx:191,tz:35,type:'sentinel_drone'},
    {tx:199,tz:35,type:'sentinel_drone'},
    {tx:208,tz:36,type:'neon_wraith'},
    {tx:208,tz:42,type:'neon_wraith'},
    {tx:203,tz:32,type:'skybridge_sniper'},
    {tx:207,tz:45,type:'skybridge_sniper'},
    {tx:169,tz:45,type:'hollow_enforcer'},
    {tx:173,tz:38,type:'hollow_enforcer'},
    {tx:169,tz:34,type:'maintenance_striker'},
    {tx:171,tz:42,type:'maintenance_striker'},
    {tx:171,tz:44,type:'sentinel_drone'},
    {tx:173,tz:37,type:'sentinel_drone'},
    {tx:167,tz:44,type:'neon_wraith'},
    {tx:176,tz:45,type:'neon_wraith'},
    {tx:177,tz:44,type:'skybridge_sniper'},
    {tx:160,tz:31,type:'skybridge_sniper'},
    {tx:202,tz:79,type:'hollow_enforcer'},
    {tx:203,tz:78,type:'hollow_enforcer'},
    {tx:205,tz:70,type:'maintenance_striker'},
    {tx:194,tz:74,type:'maintenance_striker'},
    {tx:193,tz:74,type:'sentinel_drone'},
    {tx:208,tz:75,type:'sentinel_drone'},
    {tx:207,tz:69,type:'neon_wraith'},
    {tx:200,tz:71,type:'neon_wraith'},
    {tx:196,tz:67,type:'skybridge_sniper'},
    {tx:196,tz:65,type:'skybridge_sniper'},
    {tx:37,tz:201,type:'hollow_enforcer'},
    {tx:40,tz:192,type:'hollow_enforcer'},
    {tx:39,tz:198,type:'maintenance_striker'},
    {tx:44,tz:206,type:'maintenance_striker'},
    {tx:43,tz:194,type:'sentinel_drone'},
    {tx:49,tz:208,type:'sentinel_drone'},
    {tx:40,tz:199,type:'neon_wraith'},
    {tx:44,tz:205,type:'neon_wraith'},
    {tx:48,tz:201,type:'skybridge_sniper'},
    {tx:48,tz:206,type:'skybridge_sniper'},
    {tx:74,tz:200,type:'hollow_enforcer'},
    {tx:71,tz:203,type:'hollow_enforcer'},
    {tx:81,tz:202,type:'maintenance_striker'},
    {tx:70,tz:205,type:'maintenance_striker'},
    {tx:69,tz:206,type:'sentinel_drone'},
    {tx:78,tz:204,type:'sentinel_drone'},
    {tx:74,tz:201,type:'neon_wraith'},
    {tx:65,tz:209,type:'neon_wraith'},
    {tx:64,tz:200,type:'skybridge_sniper'},
    {tx:72,tz:203,type:'skybridge_sniper'},
    {tx:49,tz:164,type:'hollow_enforcer'},
    {tx:40,tz:165,type:'hollow_enforcer'},
    {tx:48,tz:168,type:'maintenance_striker'},
    {tx:41,tz:162,type:'maintenance_striker'},
    {tx:32,tz:167,type:'sentinel_drone'},
    {tx:40,tz:168,type:'sentinel_drone'},
    {tx:44,tz:163,type:'neon_wraith'},
    {tx:35,tz:172,type:'neon_wraith'},
    {tx:45,tz:177,type:'skybridge_sniper'},
    {tx:41,tz:176,type:'skybridge_sniper'},
    {tx:203,tz:194,type:'hollow_enforcer'},
    {tx:199,tz:201,type:'hollow_enforcer'},
    {tx:199,tz:203,type:'maintenance_striker'},
    {tx:199,tz:199,type:'maintenance_striker'},
    {tx:200,tz:200,type:'sentinel_drone'},
    {tx:194,tz:202,type:'sentinel_drone'},
    {tx:202,tz:199,type:'neon_wraith'},
    {tx:202,tz:201,type:'neon_wraith'},
    {tx:201,tz:192,type:'skybridge_sniper'},
    {tx:206,tz:194,type:'skybridge_sniper'},
    {tx:159,tz:209,type:'hollow_enforcer'},
    {tx:175,tz:199,type:'hollow_enforcer'},
    {tx:169,tz:209,type:'maintenance_striker'},
    {tx:166,tz:196,type:'maintenance_striker'},
    {tx:172,tz:198,type:'sentinel_drone'},
    {tx:173,tz:209,type:'sentinel_drone'},
    {tx:171,tz:201,type:'neon_wraith'},
    {tx:165,tz:196,type:'neon_wraith'},
    {tx:162,tz:203,type:'skybridge_sniper'},
    {tx:170,tz:205,type:'skybridge_sniper'},
    {tx:209,tz:163,type:'hollow_enforcer'},
    {tx:207,tz:164,type:'hollow_enforcer'},
    {tx:192,tz:162,type:'maintenance_striker'},
    {tx:205,tz:168,type:'maintenance_striker'},
    {tx:198,tz:168,type:'sentinel_drone'},
    {tx:196,tz:177,type:'sentinel_drone'},
    {tx:197,tz:177,type:'neon_wraith'},
    {tx:203,tz:161,type:'neon_wraith'},
    {tx:202,tz:167,type:'skybridge_sniper'},
    {tx:209,tz:159,type:'skybridge_sniper'},
    {tx:117,tz:58,type:'hollow_enforcer'},
    {tx:129,tz:54,type:'hollow_enforcer'},
    {tx:126,tz:59,type:'maintenance_striker'},
    {tx:125,tz:49,type:'maintenance_striker'},
    {tx:121,tz:56,type:'sentinel_drone'},
    {tx:114,tz:47,type:'sentinel_drone'},
    {tx:125,tz:51,type:'neon_wraith'},
    {tx:115,tz:59,type:'neon_wraith'},
    {tx:124,tz:56,type:'skybridge_sniper'},
    {tx:124,tz:45,type:'skybridge_sniper'},
    {tx:121,tz:181,type:'hollow_enforcer'},
    {tx:129,tz:194,type:'hollow_enforcer'},
    {tx:123,tz:192,type:'maintenance_striker'},
    {tx:115,tz:196,type:'maintenance_striker'},
    {tx:129,tz:182,type:'sentinel_drone'},
    {tx:114,tz:196,type:'sentinel_drone'},
    {tx:121,tz:186,type:'neon_wraith'},
    {tx:115,tz:184,type:'neon_wraith'},
    {tx:114,tz:189,type:'skybridge_sniper'},
    {tx:125,tz:196,type:'skybridge_sniper'},
    {tx:65,tz:115,type:'hollow_enforcer'},
    {tx:47,tz:114,type:'hollow_enforcer'},
    {tx:65,tz:128,type:'maintenance_striker'},
    {tx:61,tz:112,type:'maintenance_striker'},
    {tx:51,tz:111,type:'sentinel_drone'},
    {tx:65,tz:116,type:'sentinel_drone'},
    {tx:64,tz:117,type:'neon_wraith'},
    {tx:58,tz:118,type:'neon_wraith'},
    {tx:191,tz:118,type:'hollow_enforcer'},
    {tx:183,tz:112,type:'hollow_enforcer'},
    {tx:189,tz:117,type:'maintenance_striker'},
    {tx:192,tz:121,type:'maintenance_striker'},
    {tx:190,tz:121,type:'sentinel_drone'},
    {tx:175,tz:128,type:'sentinel_drone'},
    {tx:177,tz:129,type:'neon_wraith'},
    {tx:180,tz:123,type:'neon_wraith'},
    {tx:155,tz:170,type:'sentinel_drone'},
    {tx:56,tz:117,type:'neon_wraith'},
    {tx:52,tz:169,type:'hollow_enforcer'},
    {tx:148,tz:199,type:'crash_car'},
    {tx:103,tz:213,type:'sentinel_drone'},
    {tx:42,tz:52,type:'neon_wraith'},
    {tx:181,tz:169,type:'hollow_enforcer'},
    {tx:213,tz:54,type:'crash_car'},
    {tx:135,tz:20,type:'sentinel_drone'},
    {tx:138,tz:165,type:'neon_wraith'},
    {tx:204,tz:220,type:'hollow_enforcer'},
    {tx:41,tz:101,type:'crash_car'},
    {tx:107,tz:149,type:'sentinel_drone'},
    {tx:24,tz:59,type:'neon_wraith'},
    {tx:58,tz:184,type:'hollow_enforcer'},
    {tx:181,tz:26,type:'crash_car'},
    {tx:218,tz:124,type:'sentinel_drone'},
    {tx:169,tz:186,type:'neon_wraith'},
    {tx:70,tz:184,type:'crash_car'},
    {tx:68,tz:153,type:'sentinel_drone'},
    {tx:182,tz:90,type:'neon_wraith'},
    {tx:204,tz:166,type:'crash_car'},
    {tx:218,tz:101,type:'sentinel_drone'},
    {tx:181,tz:70,type:'neon_wraith'},
    {tx:151,tz:100,type:'crash_car'},
    {tx:119,tz:91,type:'sentinel_drone'},
    {tx:187,tz:58,type:'neon_wraith'},
    {tx:108,tz:187,type:'crash_car'},
    {tx:86,tz:133,type:'sentinel_drone'},
    {tx:87,tz:154,type:'crash_car'},
    {tx:153,tz:75,type:'sentinel_drone'},
    {tx:168,tz:36,type:'crash_car'},
    {tx:219,tz:180,type:'sentinel_drone'},
    {tx:204,tz:40,type:'crash_car'},
    {tx:84,tz:100,type:'sentinel_drone'},
    {tx:183,tz:105,type:'crash_car'},
    {tx:20,tz:103,type:'sentinel_drone'},
    {tx:57,tz:26,type:'sentinel_drone'},
    {tx:69,tz:102,type:'sentinel_drone'},
  ...
  xeron: [
    {tx:96,tz:108,type:'laser_turret'},
    {tx:96,tz:132,type:'laser_turret'},
    {tx:144,tz:108,type:'laser_turret'},
    {tx:144,tz:132,type:'laser_turret'},
    {tx:108,tz:96,type:'laser_turret'},
    {tx:132,tz:96,type:'laser_turret'},
    {tx:108,tz:144,type:'laser_turret'},
    {tx:132,tz:144,type:'laser_turret'},
    {tx:40,tz:40,type:'laser_turret'},
    {tx:200,tz:40,type:'laser_turret'},
    {tx:40,tz:200,type:'laser_turret'},
    {tx:200,tz:200,type:'laser_turret'},
    {tx:80,tz:120,type:'laser_turret'},
    {tx:160,tz:120,type:'laser_turret'},
    {tx:120,tz:80,type:'laser_turret'},
    {tx:120,tz:160,type:'laser_turret'},
    {tx:60,tz:60,type:'laser_turret'},
    {tx:180,tz:60,type:'laser_turret'},
    {tx:60,tz:180,type:'laser_turret'},
    {tx:180,tz:180,type:'laser_turret'},
    {tx:40,tz:160,type:'laser_turret'},
    {tx:200,tz:80,type:'laser_turret'},
    {tx:80,tz:200,type:'laser_turret'},
    {tx:160,tz:40,type:'laser_turret'},
    {tx:53,tz:55,type:'void_marine'},
    {tx:54,tz:41,type:'void_marine'},
    {tx:40,tz:41,type:'corrupted_xu'},
    {tx:50,tz:44,type:'corrupted_xu'},
    {tx:54,tz:52,type:'cyber_ogre'},
    {tx:46,tz:43,type:'cyber_ogre'},
    {tx:48,tz:46,type:'void_marine'},
    {tx:55,tz:47,type:'void_marine'},
    {tx:53,tz:51,type:'corrupted_xu'},
    {tx:42,tz:54,type:'corrupted_xu'},
    {tx:78,tz:47,type:'void_marine'},
    {tx:71,tz:47,type:'void_marine'},
    {tx:79,tz:47,type:'corrupted_xu'},
    {tx:72,tz:35,type:'corrupted_xu'},
    {tx:64,tz:46,type:'cyber_ogre'},
    {tx:65,tz:39,type:'cyber_ogre'},
    {tx:78,tz:39,type:'void_marine'},
    {tx:73,tz:46,type:'void_marine'},
    {tx:69,tz:35,type:'corrupted_xu'},
    {tx:80,tz:40,type:'corrupted_xu'},
    {tx:43,tz:71,type:'void_marine'},
    {tx:35,tz:70,type:'void_marine'},
    {tx:43,tz:77,type:'corrupted_xu'},
    {tx:37,tz:75,type:'corrupted_xu'},
    {tx:39,tz:80,type:'cyber_ogre'},
    {tx:32,tz:65,type:'cyber_ogre'},
    {tx:44,tz:74,type:'void_marine'},
    {tx:40,tz:65,type:'void_marine'},
    {tx:35,tz:77,type:'corrupted_xu'},
    {tx:46,tz:67,type:'corrupted_xu'},
    {tx:189,tz:48,type:'void_marine'},
    {tx:195,tz:47,type:'void_marine'},
    {tx:187,tz:55,type:'corrupted_xu'},
    {tx:195,tz:52,type:'corrupted_xu'},
    {tx:185,tz:41,type:'cyber_ogre'},
    {tx:187,tz:43,type:'cyber_ogre'},
    {tx:195,tz:45,type:'void_marine'},
    {tx:184,tz:42,type:'void_marine'},
    {tx:195,tz:50,type:'corrupted_xu'},
    {tx:189,tz:45,type:'corrupted_xu'},
    {tx:173,tz:35,type:'void_marine'},
    {tx:169,tz:47,type:'void_marine'},
    {tx:164,tz:35,type:'corrupted_xu'},
    {tx:166,tz:36,type:'corrupted_xu'},
    {tx:176,tz:34,type:'cyber_ogre'},
    {tx:165,tz:43,type:'cyber_ogre'},
    {tx:164,tz:40,type:'void_marine'},
    {tx:174,tz:40,type:'void_marine'},
    {tx:171,tz:46,type:'corrupted_xu'},
    {tx:174,tz:41,type:'corrupted_xu'},
    {tx:192,tz:64,type:'void_marine'},
    {tx:208,tz:65,type:'void_marine'},
    {tx:194,tz:66,type:'corrupted_xu'},
    {tx:195,tz:72,type:'corrupted_xu'},
    {tx:197,tz:80,type:'cyber_ogre'},
    {tx:206,tz:71,type:'cyber_ogre'},
    {tx:203,tz:70,type:'void_marine'},
    {tx:207,tz:66,type:'void_marine'},
    {tx:192,tz:76,type:'corrupted_xu'},
    {tx:204,tz:67,type:'corrupted_xu'},
    {tx:44,tz:186,type:'void_marine'},
    {tx:40,tz:190,type:'void_marine'},
    {tx:56,tz:187,type:'corrupted_xu'},
    {tx:56,tz:186,type:'corrupted_xu'},
    {tx:56,tz:196,type:'cyber_ogre'},
    {tx:50,tz:196,type:'cyber_ogre'},
    {tx:56,tz:188,type:'void_marine'},
    {tx:55,tz:198,type:'void_marine'},
    {tx:50,tz:194,type:'corrupted_xu'},
    {tx:44,tz:187,type:'corrupted_xu'},
    {tx:79,tz:200,type:'void_marine'},
    {tx:69,tz:194,type:'void_marine'},
    {tx:77,tz:197,type:'corrupted_xu'},
    {tx:77,tz:204,type:'corrupted_xu'},
    {tx:75,tz:207,type:'void_marine'},
    {tx:79,tz:207,type:'void_marine'},
    {tx:66,tz:207,type:'corrupted_xu'},
    {tx:73,tz:196,type:'corrupted_xu'},
    {tx:48,tz:170,type:'void_marine'},
    {tx:48,tz:160,type:'void_marine'},
    {tx:38,tz:163,type:'corrupted_xu'},
    {tx:41,tz:163,type:'corrupted_xu'},
    {tx:35,tz:163,type:'void_marine'},
    {tx:42,tz:163,type:'void_marine'},
    {tx:47,tz:168,type:'corrupted_xu'},
    {tx:41,tz:175,type:'corrupted_xu'},
    {tx:193,tz:186,type:'void_marine'},
    {tx:190,tz:192,type:'void_marine'},
    {tx:197,tz:198,type:'corrupted_xu'},
    {tx:194,tz:196,type:'corrupted_xu'},
    {tx:188,tz:184,type:'void_marine'},
    {tx:188,tz:194,type:'void_marine'},
    {tx:186,tz:198,type:'corrupted_xu'},
    {tx:184,tz:193,type:'corrupted_xu'},
    {tx:168,tz:203,type:'void_marine'},
    {tx:161,tz:202,type:'void_marine'},
    {tx:176,tz:205,type:'corrupted_xu'},
    {tx:161,tz:199,type:'corrupted_xu'},
    {tx:169,tz:195,type:'void_marine'},
    {tx:168,tz:205,type:'void_marine'},
    {tx:176,tz:206,type:'corrupted_xu'},
    {tx:168,tz:208,type:'corrupted_xu'},
    {tx:204,tz:163,type:'corrupted_xu'},
    {tx:202,tz:165,type:'corrupted_xu'},
    {tx:204,tz:164,type:'corrupted_xu'},
    {tx:207,tz:163,type:'corrupted_xu'},
    {tx:120,tz:46,type:'corrupted_xu'},
    {tx:116,tz:48,type:'corrupted_xu'},
    {tx:112,tz:59,type:'corrupted_xu'},
    {tx:118,tz:55,type:'corrupted_xu'},
    {tx:124,tz:186,type:'corrupted_xu'},
    {tx:113,tz:191,type:'corrupted_xu'},
    {tx:122,tz:187,type:'corrupted_xu'},
    {tx:112,tz:185,type:'corrupted_xu'},
    {tx:61,tz:124,type:'corrupted_xu'},
    {tx:53,tz:127,type:'corrupted_xu'},
    {tx:62,tz:128,type:'corrupted_xu'},
    {tx:59,tz:118,type:'corrupted_xu'},
    {tx:179,tz:124,type:'corrupted_xu'},
    {tx:183,tz:120,type:'corrupted_xu'},
    {tx:192,tz:125,type:'corrupted_xu'},
    {tx:180,tz:128,type:'corrupted_xu'},
    {tx:136,tz:153,type:'holo_wraith'},
    {tx:134,tz:41,type:'shard_assassin'},
    {tx:135,tz:203,type:'holo_wraith'},
    {tx:138,tz:166,type:'holo_wraith'},
    {tx:41,tz:70,type:'shard_assassin'},
    {tx:58,tz:171,type:'holo_wraith'},
    {tx:200,tz:106,type:'holo_wraith'},
    {tx:217,tz:149,type:'shard_assassin'},
    {tx:100,tz:212,type:'holo_wraith'},
    {tx:122,tz:149,type:'holo_wraith'},
    {tx:185,tz:140,type:'shard_assassin'},
    {tx:28,tz:26,type:'holo_wraith'},
    {tx:218,tz:74,type:'holo_wraith'},
    {tx:156,tz:215,type:'shard_assassin'},
    {tx:215,tz:204,type:'holo_wraith'},
    {tx:150,tz:70,type:'holo_wraith'},
    {tx:28,tz:153,type:'shard_assassin'},
    {tx:170,tz:212,type:'holo_wraith'},
    {tx:219,tz:92,type:'holo_wraith'},
    {tx:92,tz:84,type:'shard_assassin'},
    {tx:21,tz:58,type:'holo_wraith'},
    {tx:220,tz:212,type:'holo_wraith'},
    {tx:88,tz:42,type:'shard_assassin'},
    {tx:58,tz:25,type:'holo_wraith'},
    {tx:23,tz:168,type:'holo_wraith'},
    {tx:92,tz:20,type:'shard_assassin'},
    {tx:43,tz:100,type:'holo_wraith'},
    {tx:89,tz:68,type:'holo_wraith'},
    {tx:84,tz:168,type:'shard_assassin'},
    {tx:187,tz:217,type:'holo_wraith'},
    {tx:216,tz:24,type:'holo_wraith'},
    {tx:154,tz:107,type:'shard_assassin'},
    {tx:214,tz:54,type:'holo_wraith'},
    {tx:72,tz:172,type:'holo_wraith'},
    {tx:91,tz:122,type:'shard_assassin'},
    {tx:154,tz:88,type:'holo_wraith'},
    {tx:196,tz:216,type:'holo_wraith'},
    {tx:20,tz:88,type:'shard_assassin'},
    {tx:171,tz:90,type:'holo_wraith'},
    {tx:213,tz:104,type:'holo_wraith'},
    {tx:151,tz:139,type:'shard_assassin'},
    {tx:187,tz:53,type:'holo_wraith'},
    {tx:213,tz:118,type:'holo_wraith'},
    {tx:57,tz:200,type:'shard_assassin'},
    {tx:196,tz:138,type:'holo_wraith'},
    {tx:132,tz:90,type:'holo_wraith'},
    {tx:104,tz:87,type:'shard_assassin'},
    {tx:202,tz:186,type:'holo_wraith'},
    {tx:152,tz:149,type:'holo_wraith'},
    {tx:152,tz:187,type:'shard_assassin'},
    {tx:88,tz:215,type:'holo_wraith'},
    {tx:71,tz:119,type:'holo_wraith'},
    {tx:218,tz:171,type:'shard_assassin'},
    {tx:59,tz:54,type:'holo_wraith'},
  ],
